...
if ((game.PlaceId == 6403373529) or (game.PlaceId == 9015014224)) then
	...
	Tab1:AddButton({Name="Execute | Ui Library [ PE ]",Callback=function()
	...
	Tab1:AddButton({Name="Auto Farm Bob",Callback=function()
	...
	Tab3:AddDropdown({Name="Retro Obby",Default="",Options={"Get Badge","Show All","Off Show All","Teleport Spawn 1","Teleport Spawn 2","Teleport Spawn 3","Click Button"},Callback=function(Value)
	...
	Tab3:AddButton({Name="Get Glove Warp",Callback=function()
	...
	Tab3:AddButton({Name="Auto Quests Chest All Glove",Callback=function()
		if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
			repeat
				...
				game:GetService("ReplicatedStorage").DigEvent:FireServer({index=2,cf=CFrame.new(42.7222366, -6.17449856, 91.5175781, -0.414533257, 0.000017259435, -0.91003418, -0.000055703724, 1, 0.000044339522, 0.91003418, 0.0000690725, -0.414533257)});
...
for i,v in ipairs(game:GetService("Workspace"):GetDescendants()) do
	...
	Tab3:AddButton({Name="Auto Get Glove Admin",Callback=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
            if not game:IsLoaded() then
...
game:GetService("TeleportService"):Teleport(6403373529)
	...
	Tab3:AddButton({Name="Get Counter + Elude",Callback=function()
...
fireclickdetector(v)
	...
	Tab3:AddButton({Name="Get The Schlop",Callback=function()
	...
	Tab3:AddToggle({Name="Siphon Farm",Default=false,Callback=function(Value)
		_G.Siphonfarm = Value;
	...
	Tab3:AddToggle({Name="Phase Or Jet Glitch",Default=false,Callback=function(Value)
		_G.Glitchfarm = Value;
	...
	Tab3:AddToggle({Name="Gift Farm",Default=false,Callback=function(Value)
		Giftfarm = Value;
		while Giftfarm do
			for i, v in pairs(game.Workspace:GetChildren()) do
				if (v.Name == "Gift") then
	...
	Tab3:AddDropdown({Name="Farm Time",Default="",Options={"Voodoo + Fish","MegaRock"},Callback=function(Value)
		AutoTime = Value;
	end});
	FarmTimeServer = Tab3:AddLabel("Farm Time [ 0 ]");
	GetFarmTime = Tab3:AddToggle({Name="AutoFarm Time",Default=false,Callback=function(Value)
	...
	Tab5:AddTextbox({Name="WalkSpeed",Default="UserSpeed",TextDisappear=false,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value;
		Walkspeed = Value;
	end});
	...
	Tab5:AddTextbox({Name="Jumppower",Default="UserPower",TextDisappear=false,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value;
		Jumppower = Value;
	end});
	...
	Tab5:AddSlider({Name="Hip Height",Min=0,Max=100,Default=0,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Hip Height",Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.HipHeight = Value;
		HipHeight = Value;
	end});
	Tab5:AddTextbox({Name="Hip Height",Default="UserHeight",TextDisappear=false,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.HipHeight = Value;
		HipHeight = Value;
	end});
	...
	Tab5:AddSlider({Name="Gravity",Min=0,Max=600,Default=196,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Gravity",Callback=function(Value)
	...
	AutoSpawnDivebomb = Tab14:AddToggle({Name="Auto Spam Divebomb",Default=false,Callback=function(Value)
		...
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Divebomb") then
			while _G.DivebombSpam and (game.Players.LocalPlayer.leaderstats.Glove.Value == "Divebomb") do
				game:GetService("ReplicatedStorage").RocketJump:InvokeServer({chargeAlpha=99.78333338815719,rocketJump=true});
	...
	Tab14:AddTextbox({Name="Punish Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Cancel = false;
	Tab14:AddButton({Name="Punish Player",Callback=function()
	...
	Tab14:AddDropdown({Name="Player",Default="Username",Options={"Username","Random"},Callback=function(Value)
		_G.PlayerChoose = Value;
	end});
	Tab14:AddTextbox({Name="Teleport Void Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddButton({Name="Teleport Void Player",Callback=function()
	...
	Tab14:AddTextbox({Name="Home Run Kill Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddButton({Name="Home Run Kill Player",Callback=function()
		if (_G.PlayerChoose == "Username") then
	...
	Tab14:AddTextbox({Name="Hive Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddButton({Name="Hive Player",Callback=function()
		if (_G.PlayerChoose == "Username") then
	...
	Tab14:AddTextbox({Name="Quake Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddButton({Name="Quake Player",Callback=function()
		if (_G.PlayerChoose == "Username") then
	...
	Tab14:AddTextbox({Name="Cards Player",Default="Username",TextDisappear=false,Callback=function(Value)
		if ((Value == "Me") or (Value == "me") or (Value == "Username") or (Value == "")) then
	...
	Tab14:AddTextbox({Name="Oven Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddTextbox({Name="Siphon Player",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	AutoSiphon = Tab14:AddToggle({Name="Auto Siphon Player",Default=false,Callback=function(Value)
	...
	Tab14:AddButton({Name="Kick Player Recall",Callback=function()
		if (_G.PlayerChoose == "Username") then
	...
	Tab14:AddToggle({Name="Auto Sbeve All Player",Default=false,Callback=function(Value)
	...
	Tab14:AddButton({Name="Sbeve All Player",Callback=function()
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Sbeve") or game.Players.LocalPlayer.Character:FindFirstChild("stevebody")) then
			for i, v in pairs(game.Players:GetChildren()) do
				if ((v ~= game.Players.LocalPlayer) and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and v.Character) then
					if (v.Character:FindFirstChild("entered") and v.Character:FindFirstChild("HumanoidRootPart") and (v.Character:FindFirstChild("stevebody") == nil) and (v.Character:FindFirstChild("rock") == nil) and (v.Character.Ragdolled.Value == false)) then
	...
	Tab14:AddButton({Name="Auto Enter Map Null",Callback=function()
	...
	Tab14:AddButton({Name="Auto Enter Cannon",Callback=function()
	...
	Tab14:AddButton({Name="Replica UNO",Callback=function()
		if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
			if (game.Players.LocalPlayer.Character.Humanoid.Health ~= 0) then
				game:GetService("ReplicatedStorage"):WaitForChild("HumanoidDied"):FireServer(game.Players.LocalPlayer.Character, false);
			end
	...
	Tab14:AddTextbox({Name="Grab Player Teleport",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab14:AddButton({Name="Grab Player Teleport",Callback=function()
	...
	Tab14:AddButton({Name="Spawn Orb Siphon",Callback=function()
	...
	Tab14:AddDropdown({Name="Potions",Default="",Options={"Nuke","Normal"},Callback=function(Value)
	...
	Tab14:AddDropdown({Name="Equipped Glove Farm",Default="",Options={"Baller","Replica","Blink","Reverse"},Callback=function(Value)
		if (game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil) then
	...
	Tab14:AddDropdown({Name="Will Teleport Farm",Default="SafeSpotBox 1.0",Options={"Up To You","SafeSpotBox 1.0","SafeSpotBox 2.0"},Callback=function(Value)
		_G.GetTeleport = Value;
	end});
	Tab14:AddDropdown({Name="Slap Farm",Default="Normal",Options={"Normal","Fast × Slap Farm [ Lag ]"},Callback=function(Value)
		_G.GetSlapGot = Value;
	end});
	Tab14:AddSlider({Name="Slap Farm",Min=1,Max=2000,Default=1,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Slap",Callback=function(Value)
		_G.SlapFarmGet = Value;
	end});
	ReplicaAndReverse = Tab14:AddToggle({Name="Reverse + Replica Slap Farm",Default=false,Callback=function(Value)
	...
	BlinkAndReverse = Tab14:AddToggle({Name="Reverse + Blink Slap Farm",Default=false,Callback=function(Value)
	...
	ReplicaBlinkReverseBaller = Tab14:AddToggle({Name="Reverse + Replica & Blink | Baller Slap Farm",Default=false,Callback=function(Value)
	...
	ReplicaAndBallerFarm = Tab14:AddToggle({Name="Baller & Replica Slap Farm",Default=false,Callback=function(Value)
	...
	ReplicaAndBallerAndBlinkFarm = Tab14:AddToggle({Name="Baller & Replica & Bink Slap Farm",Default=false,Callback=function(Value)
	...
	FarmBaller = Tab14:AddToggle({Name="Auto Slap Baller",Default=false,Callback=function(Value)
		_G.BallerFarm = Value;
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Baller") and game.Players.LocalPlayer.Character:FindFirstChild("entered")) then
	...
	FarmReplica = Tab14:AddToggle({Name="Auto Slap Replica",Default=false,Callback=function(Value)
		ReplicaFarm = Value;
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Replica") and (game.Players.LocalPlayer.Character.IsInDefaultArena.Value == true)) then
	...
	FarmBlink = Tab14:AddToggle({Name="Auto Slap Blink",Default=false,Callback=function(Value)
		BlinkFarm = Value;
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Blink") and game.Players.LocalPlayer.Character:FindFirstChild("entered")) then
	...
	Tab14:AddDropdown({Name="Godmode Glove",Default="Golden",Options={"Reverse","Golden"},Callback=function(Value)
		SetGodmode = Value;
	end});
	Tab14:AddToggle({Name="Auto Godmode",Default=false,Callback=function(Value)
		AutoGodmode = Value;
	...
	Tab14:AddColorpicker({Name="Color Skin",Default=Color3.fromRGB(255, 0, 0),Callback=function(Value)
		_G.skinColor = Value;
	end});
	...
	Tab14:AddToggle({Name="Invisible Reverse",Default=false,Callback=function(Value)
		Invis_Reverse = Value;
		while Invis_Reverse do
			repeat
				task.wait();
			until game.Players.LocalPlayer.Character:FindFirstChild("SelectionBox", 1) and game.Players.LocalPlayer.Character:FindFirstChild("Head"):FindFirstChild("UnoReverseCard") 
	...
	Tab7:AddToggle({Name="Infinity Jump",Default=false,Callback=function(Value)
	...
	Tab7:AddDropdown({Name="Teleport",Default="",Options={"Arena","Lobby","Hunter Room","Brazil","Island Slapple","Plate","Tournament","Cannon Island","Equip Glovel","Keypad","Cube Of Death","Moai Island","Default Arena","Island 1","Island 2","Island 3"},Callback=function(Value)
		if (Value == "Arena") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.workspace.Origo.CFrame * CFrame.new(0, -5, 0);
	...
	Tab7:AddDropdown({Name="Animation Combat",Default="",Options={"Skukuchi Attacker","Skukuchi Target","Bomb Throw","Bubble Shoot","Revolver","Ban Hammer","Slapstick","Dual","Slap","Bomb","Rocket Launcher","Rojo","Rojo Recoil","Thor","Rob"},Callback=function(Value)
	...
	Tab7:AddTextbox({Name="Animation",Default="Id Animation",TextDisappear=false,Callback=function(Value)
		_G.Animation = Value;
	end});
	Tab7:AddButton({Name="Start Animation | Edit ID",Callback=function()
	...
	Tab7:AddButton({Name="Stop Animation | Destroy",Callback=function()
		if (game.ReplicatedStorage:FindFirstChild("Animation") ~= nil) then
	...
	Tab7:AddToggle({Name="Autofarm Slapples",Default=false,Callback=function(Value)
		SlappleFarm = Value;
	...
	Tab7:AddToggle({Name="Autofarm Candy",Default=false,Callback=function(Value)
	...
	Tab7:AddTextbox({Name="Player View",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddToggle({Name="Auto View Player",Default=false,Callback=function(Value)
		_G.PlayerView = Value;
	...
	Tab7:AddTextbox({Name="Speed Fly",Default="Userspeed",TextDisappear=false,Callback=function(Value)
		_G.SetSpeedFly = Value;
	end});
	_G.SetSpeedFly = 100;
	Tab7:AddToggle({Name="Start Fly",Default=false,Callback=function(Value)
		_G.StartFly = Value;
	...
	Tab7:AddDropdown({Name="Pocket",Default="Add All Player",Options={"Add All Player","Remove All Player"},Callback=function(Value)
		_G.StartMusicGot = Value;
	end});
	Tab7:AddButton({Name="Pocket Player",Callback=function()
	...
	Tab7:AddTextbox({Name="Play Pocket Radio",Default="UserIDMusic",TextDisappear=false,Callback=function(Value)
		_G.IDPocketRadio = Value;
	end});
	Tab7:AddDropdown({Name="Music",Default="Play",Options={"Play","Stop"},Callback=function(Value)
		_G.StartMusicGot = Value;
	end});
	Tab7:AddButton({Name="Play Music",Callback=function()
	...
	Notifykeypad = Tab7:AddToggle({Name="Auto Notification Keypad",Default=false,Callback=function(Value)
		_G.NotifyKeypad = Value;
		while _G.NotifyKeypad do
			if not game.Workspace:FindFirstChild("Keypad") then
				repeat
					task.wait();
				until game.Workspace:FindFirstChild("Keypad") 
	...
	NotifyToolbox = Tab7:AddToggle({Name="Auto Notification ToolBox",Default=false,Callback=function(Value)
		_G.NotifyToolBox = Value;
		while _G.NotifyToolBox do
			if not game.Workspace:FindFirstChild("Toolbox") then
				repeat
					task.wait();
				until game.Workspace:FindFirstChild("Toolbox") 
	...
	NotifyAdminJoin = Tab7:AddToggle({Name="Auto Notification Admin Join",Default=false,Callback=function(Value)
	...
	Tab7:AddTextbox({Name="Write Code Keypad",Default="",TextDisappear=false,Callback=function(Value)
		_G.writeCode = Value;
	end});
	Tab7:AddDropdown({Name="Enter Keypad",Default="Enter",Options={"Not Enter","Enter"},Callback=function(Value)
		_G.EnterKeypad = Value;
	end});
	Tab7:AddButton({Name="Write Code Keypad Start",Callback=function()
	...
	Tab7:AddDropdown({Name="Easter Egg Code",Default="",Options={"911","8008","666","6969","1987"},Callback=function(Value)
		_G.EggCodes = Value;
	end});
	Tab7:AddButton({Name="Easter Egg Keypad",Callback=function()
		if not workspace:FindFirstChild("Keypad") then
			OrionLib:MakeNotification({Name="Error",Content="Server in don't have keypad.",Image="rbxassetid://7733658504",Time=5});
		else
			game.Workspace.CurrentCamera.CameraSubject = workspace.Keypad.Buttons.Enter;
	...
	Tab7:AddTextbox({Name="ID Badge",Default="UseId",TextDisappear=false,Callback=function(Value)
		_G.IdBadgeGetNotify = Value;
	end});
	Tab7:AddButton({Name="Check Badge",Callback=function()
	...
	Tab7:AddDropdown({Name="Retro Help",Default="",Options={"Get Retro","Teleport Button","Enter Retro"},Callback=function(Value)
		_G.HelpPlayerGetHehe = Value;
	end});
	Tab7:AddTextbox({Name="Help Player Retro",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddButton({Name="Player Help Retro",Callback=function()
	...
	Tab7:AddTextbox({Name="Help Player Get Quake",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddButton({Name="Start Help Player",Callback=function()
	...
	Tab7:AddTextbox({Name="Help Player Get Goofy",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddDropdown({Name="Will Teleport Help",Default="Up To You",Options={"Up To You","SafeSpotBox 1.0","SafeSpotBox 2.0"},Callback=function(Value)
		_G.GetTeleportHelp = Value;
	end});
	Tab7:AddTextbox({Name="Help Player Get Berserk",Default="Username",TextDisappear=false,Callback=function(Value)
		local targetAbbreviation = Value;
		local targetPlayer;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #targetAbbreviation):lower() == targetAbbreviation:lower()) then
	...
	Tab7:AddSlider({Name="Time Help Berserk",Min=1,Max=3,Default=3,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Time",Callback=function(Value)
		...
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Kinetic") and game.Players.LocalPlayer.Character:FindFirstChild("entered") and game.Players[_G.HelpPlayerGetBerserk].Character:FindFirstChild("entered")) then
			for o = 1, _G.TimeHelpGotIm do
				...
				elseif ((_G.GetTeleportHelp == "SafeSpotBox 1.0") or (_G.GetTeleportHelp == "SafeSpotBox 2.0")) then
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[_G.HelpPlayerGetBerserk].Character.Head.CFrame * CFrame.new(0, 5.8, 0);
				end
				wait(0.28);
	...
	Tab7:AddSlider({Name="HipHeight AutoFarm Slap",Min=0,Max=20,Default=0,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Hip",Callback=function(Value)
		_G.HipAutoFarmSlap = Value;
	end});
	Tab7:AddToggle({Name="AutoFarm Slap",Default=false,Callback=function(Value)
	...
	Tab7:AddToggle({Name="Auto Slap Ball",Default=false,Callback=function(Value)
	...
	_G.OnAbility = false;
	Tab7:AddToggle({Name="Auto Spam Ability",Default=false,Callback=function(Value)
		_G.OnAbility = Value;
	...
	Tab7:AddDropdown({Name="Ability Spam All Glove",Default="Null",Options={"Null","Rhythm Explosion"},Callback=function(Value)
		AbilitySpamAllGlove = Value;
	end});
	Tab7:AddToggle({Name="Spam Ability All Glove",Default=false,Callback=function(Value)
		SpamAbility = Value;
	...
	Tab7:AddToggle({Name="Spam Ability 250 Kill",Default=false,Callback=function(Value)
	...
	Tab7:AddToggle({Name="AutoFarm Kill",Default=false,Callback=function(Value)
		_G.AutoFarmKill = Value;
		if (_G.AutoFarmKill == true) then
			if (_G.ClosestMagnitude == nil) then
				_G.ClosestMagnitude = 99999;
			end
		elseif _G.ClosestMagnitude then
			_G.ClosestMagnitude = nil;
		end
	...
	RhythmNote = Tab7:AddToggle({Name="Infinite Rhythm",Default=false,Callback=function(Value)
	...
	Tab7:AddButton({Name="Auto Play Rhythm",Callback=function()
	...
	Tab7:AddDropdown({Name="Rojo Spawn",Default="",Options={"Attack","Attack Fake"},Callback=function(Value)
	...
	Tab7:AddButton({Name="Free All Animations",Callback=function()
	...
	Tab7:AddButton({Name="Destroy All Tycoon",Callback=function()
	...
	Tab7:AddTextbox({Name="Glove",Default="Use Glove",TextDisappear=false,Callback=function(Value)
		_G.EquipGlove = Value;
	end});
	Tab7:AddDropdown({Name="Equip Glove",Default="",Options={"Normal","Tournament"},Callback=function(Value)
		_G.GloveEquipHehe = Value;
	end});
	Tab7:AddButton({Name="Start Equip Glove",Callback=function()
	...
	Tab7:AddTextbox({Name="ID Game",Default="UseId",TextDisappear=false,Callback=function(Value)
		_G.IDGame = Value;
	end});
	Tab7:AddButton({Name="Teleport To Game ID",Callback=function()
		game:GetService("TeleportService"):Teleport(_G.IDGame);
	end});
	Tab7:AddButton({Name="Slap Battles",Callback=function()
		if (game.PlaceId ~= 6403373529) then
			game:GetService("TeleportService"):Teleport(6403373529);
		end
	end});
	Tab7:AddButton({Name="Serverhop",Callback=function()
		local serverList = {};
	...
	Tab7:AddButton({Name="Destroy Light & Sky",Callback=function()
		for _, v in pairs(game.Lighting:GetChildren()) do
			v:Destroy();
		end
	end});
	Tab7:AddDropdown({Name="Enter",Default="Arena",Options={"Arena","Arena Default"},Callback=function(Value)
		AutoEnter = Value;
	end});
	Tab7:AddToggle({Name="Auto Enter",Default=false,Callback=function(Value)
		_G.AutoEnter = Value;
	...
	Tab7:AddSlider({Name="Reach Slap Aura",Min=10,Max=50,Default=25,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Reach",Callback=function(Value)
		_G.ReachSlapArua = Value;
	end});
	Tab7:AddDropdown({Name="Slap Aura Friend",Default="Fight",Options={"Fight","Not Fight"},Callback=function(Value)
		SlapAuraFriend = Value;
	end});
	Tab7:AddDropdown({Name="Slap Aura Character",Default="Head",Options={"HumanoidRootPart","Head","Left Arm","Left Leg","Right Arm","Right Leg"},Callback=function(Value)
		SlapAuraCharacter = Value;
	end});
	Tab7:AddDropdown({Name="Slap Aura Choose",Default="Normal",Options={"Normal","Reverse"},Callback=function(Value)
	...
	Tab7:AddDropdown({Name="Shukuchi Friend",Default="Fight",Options={"Fight","Not Fight"},Callback=function(Value)
		ShukuchiFriend = Value;
	end});
	AutoShukuchi = Tab7:AddToggle({Name="Auto Shukuchi Player",Default=false,Callback=function(Value)
	...
	Tab7:AddSlider({Name="Reach HitBox",Min=2,Max=30,Default=10,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="Reach",Callback=function(Value)
	...
	Tab7:AddColorpicker({Name="Color ESP",Default=Color3.fromRGB(111, 255, 0),Callback=function(Value)
		_G.ColorESP = Value;
	end});
	Tab7:AddToggle({Name="ESP Glove",Default=false,Callback=function(Value)
		_G.GloveESP = Value;
	...
	Tab7:AddTextbox({Name="Auto Change Nametag",Default="Nametag",TextDisappear=false,Callback=function(Value)
		game.Workspace.NametagChanged.Value = Value;
	end});
	Tab7:AddToggle({Name=" Auto Change Nametag",Default=false,Callback=function(Value)
	...
	Tab7:AddTextbox({Name="Auto Change Slap Fake",Default="Slap",TextDisappear=false,Callback=function(Value)
		game.Workspace.NametagChanged.SlapChanged.Value = Value;
	end});
	Tab7:AddToggle({Name=" Auto Change Slap Fake",Default=false,Callback=function(Value)
	...
	Tab7:AddDropdown({Name="Tycoon Auto",Default="All",Options={"All","Your"},Callback=function(Value)
		_G.TycoonAuto = Value;
	end});
	Tab7:AddToggle({Name="Auto Click Tycoon",Default=false,Callback=function(Value)
	...
	Tab7:AddToggle({Name="Auto Destroy Tycoon",Default=false,Callback=function(Value)
	...
	Tab2:AddToggle({Name="All Toggle Anti",Default=false,Callback=function(Value)
		game.Workspace.NoChanged.Value = Value;
	end});
	if (_G.AntiVoidChoose == nil) then
		_G.AntiVoidChoose = "Normal";
	end
	Tab2:AddDropdown({Name="Anti Void",Default="Normal",Options={"Normal","Retro","Water","Psycho","Bob"},Callback=function(Value)
	...
	Tab2:AddSlider({Name="Transparency Anti Void",Min=0,Max=1,Default=0.5,Color=Color3.fromRGB(255, 255, 255),Increment=0.1,ValueName="Transparency",Callback=function(Value)
	...
	AntiAdmin = Tab2:AddToggle({Name="Anti Mod | Admin",Default=false,Callback=function(Value)
		_G.AntiMods = Value;
	...
	AntiAfk = Tab2:AddToggle({Name="Anti Afk",Default=false,Callback=function(Value)
		_G.AntiAfk = Value;
		for i, v in next, getconnections(game.Players.LocalPlayer.Idled) do
			if _G.AntiAfk then
				v:Disable();
	...
	AntiSbeve = Tab2:AddToggle({Name="Anti Sbeve",Default=false,Callback=function(Value)
		_G.AntiSbeve = Value;
	...
	AntiBallBaller = Tab2:AddToggle({Name="Anti Ball Baller",Default=false,Callback=function(Value)
	...
	AntiLure = Tab2:AddToggle({Name="Anti Lure",Default=false,Callback=function(Value)
		_G.AntiLure = Value;
	...
	AntiMittenBl = Tab2:AddToggle({Name="Anti Mitten Blind",Default=false,Callback=function(Value)
	...
	AntiKnock = Tab2:AddToggle({Name="Anti Knockoff",Default=false,Callback=function(Value)
		_G.AntiKnock = Value;
	...
	AntiSquid = Tab2:AddToggle({Name="Anti Squid",Default=false,Callback=function(Value)
		_G.AntiSquid = Value;
	...
	AntiConveyor = Tab2:AddToggle({Name="Anti Conveyor",Default=false,Callback=function(Value)
		game.Players.LocalPlayer.PlayerScripts.ConveyorVictimized.Disabled = Value;
	end});
	AntiNightmareAndPotion = Tab2:AddToggle({Name="Anti Nightmare & Potion",Default=false,Callback=function(Value)
		if (Value == true) then
	...
	AntiIceAndPotion = Tab2:AddToggle({Name="Anti Ice & Potion",Default=false,Callback=function(Value)
		_G.AntiIce = Value;
		while _G.AntiIce do
			for i, v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
	...
	AntiTime = Tab2:AddToggle({Name="Anti Time Stop & Stop",Default=false,Callback=function(Value)
	...
	AntiRun = Tab2:AddToggle({Name="Anti Run",Default=false,Callback=function(Value)
		_G.AutoExit = Value;
	...
	AntiBrick = Tab2:AddToggle({Name="Anti Brick",Default=false,Callback=function(Value)
		_G.AntiBrick = Value;
	...
	AntiReda = Tab2:AddToggle({Name="Anti [REDACTED]",Default=false,Callback=function(Value)
	...
	AntiFort = Tab2:AddToggle({Name="Anti Fort",Default=false,Callback=function(Value)
		_G.AntiFort = Value;
	...
	AntiDefend = Tab2:AddToggle({Name="Anti Defend",Default=false,Callback=function(Value)
	...
	AntiAttackPlank = Tab2:AddToggle({Name="Anti Attack Plank",Default=false,Callback=function(Value)
		_G.AntiPlank = Value;
	...
	AntiBubble = Tab2:AddToggle({Name="Anti Bubble",Default=false,Callback=function(Value)
		_G.AntiBubble = Value;
	...
	Tab11:AddDropdown({Name="Glove Sound",Default="Ghost",Options={"Ghost","Thanos","Space","Scythe","Golden","Hitman","Prop","Error Death","Zombie"},Callback=function(Value)
		GloveSound = Value;
	end});
	Tab11:AddToggle({Name="Auto Spam Glove Sound",Default=false,Callback=function(Value)
	...
	Tab15:AddButton({Name="Copy Join Zalo",Callback=function()
		setclipboard("https://zalo.me/g/qlukiy407");
	end});
	Tab15:AddButton({Name="Copy Join Slap Battles Group",Callback=function()
		setclipboard("https://discord.com/invite/xdCKBcS6");
	end});
	Tab15:AddButton({Name="[ Destroy GUI ] [ Toggle Gui ]",Callback=function()
...
elseif (game.PlaceId == 11520107397) then
	...
	Tab1:AddButton({Name="Teleport SafeBox",Callback=function()
		if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace['SafeBox'].CFrame * CFrame.new(0, 5, 0);
		end
	end});
...
fireclickdetector(v)
	...
	Tab7:AddDropdown({Name="Teleport",Default="",Options={"Arena","Lobby","Hunter Room","Brazil","Island Slapple","Plate","Tournament","Cannon Island","Keypad","Moai Island","Island 1","Island 2","Island 3"},Callback=function(Value)
		if (Value == "Arena") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.workspace.Origo.CFrame * CFrame.new(0, -5, 0);
		elseif (Value == "Lobby") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-800, 328, -2.5);
	...
	Tab7:AddToggle({Name="ESP Kill",Default=false,Callback=function(Value)
		_G.KillESP = Value;
	...
	Tab7:AddToggle({Name="Spam Ability 75 & 100 Kill",Default=false,Callback=function(Value)
		_G.SpamAbliKilll = Value;
		while _G.SpamAbliKilll do
			game:GetService("ReplicatedStorage").KSABILI:FireServer();
			wait(6.9);
	...
	Tab2:AddDropdown({Name="Anti Void",Default="Normal",Options={"Normal","Bob"},Callback=function(Value)
		if (_G.AntiVoid == true) then
			AntiVoid:Set(false);
			wait(0.05);
			_G.AntiVoidChoose = Value;
...
elseif (game.PlaceId == 11828384869) then
	...
	Tab:AddButton({Name="Get Counter + Elude",Callback=function()
		Time = 121;
		fireclickdetector(game.Workspace.CounterLever.ClickDetector);
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(0, 100, 0);
		wait(0.2);
...
elseif (game.PlaceId == 13833961666) then
	...
	Tab:AddToggle({Name="Slap Aura Bob Clone [ Test... ]",Default=false,Callback=function(Value)
...
elseif (game.PlaceId == 9431156611) then
	...
	Tab:AddToggle({Name="Auto Get All Item",Default=false,Callback=function(Value)
...
elseif (game.PlaceId == 17290438723) then
	local Window = OrionLib:MakeWindow({IntroText=GameName,IntroIcon="rbxassetid://15315284749",Name=("Giang Hub - " .. GameName .. " | " .. identifyexecutor()),IntroToggleIcon="rbxassetid://7734091286",HidePremium=false,SaveConfig=false,IntroEnabled=true,ConfigFolder="slap battles"});
	local Tab = Window:MakeTab({Name="Main",Icon="rbxassetid://4370318685",PremiumOnly=false});
	Tab:AddLabel("Owner Credits Script By [ Giang ]");
	Tab:AddLabel("DonjoSx Shared Script Me, GoodLuck");
	Tab:AddParagraph("Game's ID [ " .. game.PlaceId .. " ]", "Server ID [ " .. game.JobId .. " ]");
	local InfoServer = Tab:AddSection({Name="Misc"});
	Tab:AddButton({Name="Get Badge",Callback=function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-554, 177, 56);
		wait(0.7);
		for i, v in ipairs(game:GetService("Workspace"):GetDescendants()) do
			if (v.ClassName == "ProximityPrompt") then
...
elseif (game.PlaceId == 18550498098) then
	...
	local Tab = Window:MakeTab({Name="Misc",Icon="rbxassetid://4370318685",PremiumOnly=false});
	local Tab1 = Window:MakeTab({Name="Anti",Icon="rbxassetid://7734056608",PremiumOnly=false});
	local Tab2 = Window:MakeTab({Name="Local",Icon="rbxassetid://4335489011",PremiumOnly=false});
	Tab:AddButton({Name="Start Enter + 1 HP",Callback=function()
	...
	Tab:AddButton({Name="Start Enter",Callback=function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(3258, -68, 823);
		wait(2);
		for i, v in pairs(game.Workspace:GetDescendants()) do
			if ((v.Name == "ShackLever") and v:FindFirstChild("ClickDetector")) then
	...
	Tab:AddToggle({Name="Fight Trask",Default=false,Callback=function(Value)
		_G.BringTrask = Value;
	...
	Tab:AddToggle({Name="Fight Boss Final",Default=false,Callback=function(Value)
	...
	Tab:AddToggle({Name="Fight Replica",Default=false,Callback=function(Value)
	...
	Tab:AddToggle({Name="Fight Golem",Default=false,Callback=function(Value)
		_G.FightGolem = Value;
	...
	Tab:AddButton({Name="Fight Potato",Callback=function()
	...
	Tab:AddButton({Name="Lever Start",Callback=function()
		for i, v in pairs(game.Workspace:GetDescendants()) do
	...
	Tab:AddButton({Name="Teleport Safe",Callback=function()
	...
	Tab:AddButton({Name="Teleport Fight Guide",Callback=function()
		if game.Workspace.VoidPart:FindFirstChild("Safe") then
	...
	Tab1:AddToggle({Name="Anti Void",Default=false,Callback=function(Value)
		game.Workspace.VoidPart.CanCollide = Value;
		if (Value == true) then
			game.Workspace.VoidPart.Transparency = 0.5;
		else
	...
	Tab1:AddToggle({Name="Anti Wall",Default=false,Callback=function(Value)
		_G.AntiWall = Value;
	...
	Tab2:AddSlider({Name="WalkSpeed",Min=20,Max=1000,Default=20,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="WalkSpeed",Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value;
		Walkspeed = Value;
	end});
	Tab2:AddTextbox({Name="WalkSpeed",Default="UserSpeed",TextDisappear=false,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value;
		Walkspeed = Value;
	end});
	Tab2:AddToggle({Name="Walkspeed Set Auto",Default=false,Callback=function(Value)
		KeepWalkspeed = Value;
		while KeepWalkspeed do
			if ((game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") ~= nil) and (game.Players.LocalPlayer.Character.Humanoid.WalkSpeed ~= Walkspeed)) then
				game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Walkspeed;
	...
	Tab2:AddSlider({Name="JumpPower",Min=50,Max=1000,Default=50,Color=Color3.fromRGB(255, 255, 255),Increment=1,ValueName="JumpPower",Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value;
		Jumppower = Value;
	end});
	Tab2:AddTextbox({Name="Jumppower",Default="UserPower",TextDisappear=false,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value;
		Jumppower = Value;
	end});
	Tab2:AddToggle({Name="Jumppower Set Auto",Default=false,Callback=function(Value)
		KeepJumppower = Value;
		while KeepJumppower do
			if ((game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") ~= nil) and (game.Players.LocalPlayer.Character.Humanoid.JumpPower ~= Jumppower)) then
				game.Players.LocalPlayer.Character.Humanoid.JumpPower = Jumppower;
...
elseif (game.PlaceId == 18698003301) then
	local Window = OrionLib:MakeWindow({IntroText=GameName,IntroIcon="rbxassetid://15315284749",Name=("Giang Hub - " .. GameName .. " | " .. identifyexecutor()),IntroToggleIcon="rbxassetid://7734091286",HidePremium=false,SaveConfig=false,IntroEnabled=true,ConfigFolder="slap battles"});
	local Tab = Window:MakeTab({Name="Misc",Icon="rbxassetid://4370318685",PremiumOnly=false});
	Tab:AddToggle({Name="Auto Slap Player",Default=false,Callback=function(Value)
	...
	Tab:AddToggle({Name="Auto Slap Ball",Default=false,Callback=function(Value)
		_G.AutoSlapBall = Value;
		while _G.AutoSlapBall do
	...
	Tab:AddToggle({Name="Auto View Ball",Default=false,Callback=function(Value)
