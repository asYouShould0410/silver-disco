...
if ((game.PlaceId == 6403373529) or (game.PlaceId == 9015014224) or (game.PlaceId == 11520107397) or (game.PlaceId == 124596094333302)) then
	...
	if (game.Players.LocalPlayer.PlayerGui:FindFirstChild("ButtonPlayEnter") == nil) then
		...
		spawn(function()
			while true do
				...
				elseif ((_G.ButtonEnter == true) and game.Players.LocalPlayer and game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and (game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil)) then
		...
		TextLabel.MouseEnter:Connect(function()
			...
			sound:Destroy();
			game:GetService("TweenService"):Create(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize=20}):Play();
			game:GetService("TweenService"):Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position=UDim2.new(0.5, -127, 0.5, 120),Size=UDim2.new(0, 250, 0, 53)}):Play();
		end);
		TextLabel.MouseLeave:Connect(function()
			game:GetService("TweenService"):Create(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize=15}):Play();
			game:GetService("TweenService"):Create(Frame, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position=UDim2.new(0.5, -111, 0.5, 135),Size=UDim2.new(0, 217, 0, 35)}):Play();
			local sound = Instance.new("Sound", workspace);
			sound.SoundId = "rbxassetid://10066942189";
			sound.Volume = 2;
			sound.PlaybackSpeed = 1;
		...
		TextLabel.MouseButton1Click:Connect(function()
			if (_G.ButtonEnter == true) then
				if (LoadingEnter and (LoadingEnter == true)) then
					return;
				end
				LoadingEnter = true;
				local sound = Instance.new("Sound", workspace);
				...
				game:GetService("TweenService"):Create(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize=20}):Play();
				game:GetService("TweenService"):Create(Frame, TweenInfo.new(0.01, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position=UDim2.new(0.5, -127, 0.5, 120),Size=UDim2.new(0, 250, 0, 53)}):Play();
				wait(0.5);
				game:GetService("TweenService"):Create(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextSize=15}):Play();
				game:GetService("TweenService"):Create(Frame, TweenInfo.new(0.01, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Position=UDim2.new(0.5, -111, 0.5, 135),Size=UDim2.new(0, 217, 0, 35)}):Play();
				wait(1.5);
				LoadingEnter = false;
			end
		end);
	...
	if (workspace:FindFirstChild("SafeBox") == nil) then
		...
		S2.CanCollide = true;
		S2.Transparency = 0.5;
		S2.Position = Vector3.new(-5510.27979, -4991.5, -5000.08984, -4.4703484e-7, 0, 0.999999881, 0, 1, 0, -0.999999881, 0, -3.6931945e-7);
		...
		S4.CanCollide = true;
		S4.Transparency = 0.5;
		S4.Position = Vector3.new(-5489.97559, -4991.5, -4999.52637, -4.371139e-8, 0, 1, 0, 1, 0, -1, 0, -4.371139e-8);
	...
	if (workspace:FindFirstChild("BobWalk1") == nil) then
		...
		BobWalk8.CFrame = CFrame.new(402.965027, 5.49165154, 74.8157959, 0.000029802322, -0.0000114142895, -1, -0.668144584, -0.744031429, -0.0000114142895, -0.744031489, 0.668144584, -0.000029802322);
		...
		BobWalk14.CFrame = CFrame.new(172.67041, 5.49164963, 74.8157959, -0.000045895576, 0.000020503998, 1, 0.743987858, 0.668193102, 0.000020503998, -0.668193102, 0.743987858, -0.000045895576);
...
if ((game.PlaceId == 6403373529) or (game.PlaceId == 9015014224) or (game.PlaceId == 11520107397) or (game.PlaceId == 124596094333302)) then
	local Window = Library:CreateWindow({Title="erere - Slap Battles",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Info", "rbxassetid://7734053426"),Tab1=Window:AddTab("Script", "rbxassetid://8997387937"),Tab2=Window:AddTab("Anti", "rbxassetid://7734056608"),Tab3=Window:AddTab("Badges", "rbxassetid://7733673987"),Tab4=Window:AddTab("Local", "rbxassetid://4335489011"),Tab5=Window:AddTab("Misc", "rbxassetid://4370318685"),Tab6=Window:AddTab("Gloves Optional", "rbxassetid://7733955740"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	...
	InfoServer3Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
	...
	InfoServer3Group:AddButton({Text="Check Glove / Badge",Func=function()
		local BadgeSuccess = {};
		local BadgeFailure = {};
	...
	InfoServer2Group:AddToggle("Toggle Set", {Text="Toggle Return",Default=false,Callback=function(Value)
	...
	InfoServer4Group:AddInput("GlovePlayers", {Default="",Numeric=false,Text="Search Glove",Finished=true,Placeholder="Glove",Callback=function(Value)
	...
	InfoServer4Group:AddButton({Text="Search Glove",Func=function()
		_G.GloveSearch = {};
		_G.PlayerOwner = {};
	...
	InfoServer5Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
		if ((Value ~= "") or (Value ~= " ")) then
			local PlayerTarget = Value;
			local PlayerTa;
			for _, v in pairs(game.Players:GetPlayers()) do
	...
	InfoServer5Group:AddToggle("Toggle Set", {Text="Toggle Return",Default=false,Callback=function(Value)
	...
	Script1Group:AddButton({Text="Execute | Ui Library",Func=function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Articles-Hub/ROBLOXScript/refs/heads/main/SCRIPT/Executor.lua"))();
	end});
	Script1Group:AddButton({Text="Keyboard",Func=function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/main.txt", true))();
	end});
	Script1Group:AddButton({Text="Inf yield Delta",Func=function()
	...
	Script2Group:AddButton({Text="Position Gui",Func=function()
	...
	Script2Group:AddButton({Text="Dex V2",Func=function()
	...
	Script2Group:AddButton({Text="Dex V3",Func=function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Babyhamsta/RBLX_Scripts/main/Universal/BypassedDarkDexV3.lua", true))();
	end});
	Script2Group:AddButton({Text="Dex V4",Func=function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/Articles-Hub/ROBLOXScript/refs/heads/main/SCRIPT/Dex-v4.lua"))();
	end});
	Script2Group:AddButton({Text="Simple Spy",Func=function()
	...
	Anti1Group:AddToggle("Toggle Anti", {Text="Toggle Anti",Default=false,Callback=function(Value)
		game.Workspace.NoChanged.Value = Value;
	end}):AddKeyPicker("ToggleAnti", {Default="X",Text="Toggle Anti",Mode="Toggle",SyncToggleState=true});
	local Anti2Group = Tabs.Tab2:AddRightGroupbox("Anti");
	Anti2Group:AddSlider("Transparency Anti Void", {Text="Transparency Anti Void",Default=0.5,Min=0,Max=1,Rounding=0,Compact=true,Callback=function(Value)
	...
	Anti2Group:AddDropdown("Choose Anti Void", {Text="Choose Anti Void",Values={"Normal","Retro","Water","Psycho","Bob","Fall"},Default="Normal",Multi=false,Callback=function(Value)
		if (_G.AntiVoid == true) then
	...
	Anti2Group:AddToggle("Anti Void", {Text="Anti Void",Default=false,Callback=function(Value)
		_G.AntiVoid = Value;
		if (_G.AntiVoidChoose == "Normal") then
	...
	Anti2Group:AddToggle("Anti Portal", {Text="Anti Portal",Default=false,Callback=function(Value)
		_G.AntiPortal = Value;
	...
	Anti2Group:AddToggle("Anti Admin", {Text="Anti Admin",Default=false,Callback=function(Value)
		_G.AntiMods = Value;
	...
	Anti2Group:AddToggle("Anti Kick", {Text="Anti Kick",Default=false,Callback=function(Value)
		_G.AntiKick = Value;
	...
	Anti2Group:AddToggle("Anti Afk", {Text="Anti Afk",Default=false,Callback=function(Value)
		_G.AntiAfk = Value;
	...
	Anti2Group:AddToggle("Anti Obby", {Text="Anti Obby",Default=false,Callback=function(Value)
		_G.AntiObby = Value;
	...
	Anti2Group:AddToggle("Anti Megarock", {Text="Anti Megarock | Custom",Default=false,Callback=function(Value)
		_G.AntiRock = Value;
	...
	Anti2Group:AddToggle("Anti Boss Guide", {Text="Anti Join Boss Guide",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Snowball", {Text="Anti Snowball",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Ball Baller", {Text="Anti Ball Baller",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Venom Infected", {Text="Anti Venom Infected",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Ghost Player", {Text="Anti Ghost Player",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Trap", {Text="Anti Trap",Default=false,Callback=function(Value)
		_G.AntiTrap = Value;
	...
	Anti2Group:AddToggle("Anti Lure", {Text="Anti Lure",Default=false,Callback=function(Value)
		_G.AntiLure = Value;
	...
	Anti2Group:AddToggle("Anti Mail", {Text="Anti Mail",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Water", {Text="Anti Water",Default=false,Callback=function(Value)
		_G.AntiWater = Value;
	...
	Anti2Group:AddToggle("Anti Jail Admin", {Text="Anti Jail Admin",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Mitten Blind", {Text="Anti Mitten Blind",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Knockoff", {Text="Anti Knockoff",Default=false,Callback=function(Value)
		_G.AntiKnock = Value;
	...
	Anti2Group:AddToggle("Anti Hallow", {Text="Anti Hallow - Jack",Default=false,Callback=function(Value)
		game.Players.LocalPlayer.PlayerScripts.LegacyClient.HallowJackAbilities.Disabled = Value;
	end});
	Anti2Group:AddToggle("Anti Booster", {Text="Anti Booster",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Squid", {Text="Anti Squid",Default=false,Callback=function(Value)
		_G.AntiSquid = Value;
	...
	Anti2Group:AddToggle("Anti Lamp", {Text="Anti Lamp",Default=false,Callback=function(Value)
		_G.AntiLamp = Value;
	...
	Anti2Group:AddToggle("Anti Pie", {Text="Anti Pie",Default=false,Callback=function(Value)
		_G.AntiPie = Value;
		while _G.AntiPie do
	...
	Anti2Group:AddToggle("Anti Conveyor", {Text="Anti Conveyor",Default=false,Callback=function(Value)
		game.Players.LocalPlayer.PlayerScripts.LegacyClient.ConveyorVictimized.Disabled = Value;
	end});
	Anti2Group:AddToggle("Anti Ice", {Text="Anti Ice",Default=false,Callback=function(Value)
		_G.AntiIce = Value;
		while _G.AntiIce do
	...
	Anti2Group:AddToggle("Anti Time Stop", {Text="Anti Time Stop",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Null", {Text="Anti Null",Default=false,Callback=function(Value)
		_G.AntiNull = Value;
	...
	Anti2Group:AddToggle("Anti Run", {Text="Anti Run",Default=false,Callback=function(Value)
		_G.AutoExit = Value;
	...
	Anti2Group:AddToggle("Anti Record", {Text="Anti Record",Default=false,Callback=function(Value)
		_G.AntiRecord = Value;
	end});
	...
	Anti2Group:AddToggle("Anti REDACTED", {Text="Anti [REDACTED]",Default=false,Callback=function(Value)
		game.Players.LocalPlayer.PlayerScripts.LegacyClient.Well.Disabled = Value;
	end});
	Anti2Group:AddToggle("Anti Brazil", {Text="Anti Brazil",Default=false,Callback=function(Value)
		_G.AntiBrazil = Value;
	...
	Anti2Group:AddToggle("Anti Za Hando", {Text="Anti Za Hando",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Bob", {Text="Anti Bob",Default=false,Callback=function(Value)
		_G.AntiBob = Value;
		while _G.AntiBob do
			for i, v in pairs(game.Workspace:GetChildren()) do
	...
	Anti2Group:AddToggle("Anti Fort", {Text="Anti Fort",Default=false,Callback=function(Value)
		_G.AntiFort = Value;
	...
	Anti2Group:AddToggle("Anti Pusher", {Text="Anti Pusher",Default=false,Callback=function(Value)
		_G.AntiPusher = Value;
	...
	Anti2Group:AddToggle("Anti Defend", {Text="Anti Defend",Default=false,Callback=function(Value)
	...
	Anti2Group:AddToggle("Anti Bubble", {Text="Anti Bubble",Default=false,Callback=function(Value)
		_G.AntiBubble = Value;
	...
	Anti2Group:AddToggle("Anti Stun", {Text="Anti Stun",Default=false,Callback=function(Value)
		_G.AntiStun = Value;
	...
	Anti2Group:AddToggle("Anti COD", {Text="Anti Cube Of Death",Default=false,Callback=function(Value)
		if (Value == true) then
		...
		elseif (game.Workspace:FindFirstChild("the cube of death(i heard it kills)", 1) and game.Workspace.Arena.CubeOfDeathArea["the cube of death(i heard it kills)"]:FindFirstChild("Part")) then
	...
	Anti2Group:AddToggle("Anti Death Barriers", {Text="Anti Death Barriers",Default=false,Callback=function(Value)
		if (Value == true) then
	...
	Anti2Group:AddToggle("Anti Ragdoll", {Text="Anti Ragdoll",Default=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Teleport Safe", {Text="Teleport Safe",Values={"SafeSpotBox 1.0","SafeSpotBox 2.0","Bed"},Default="",Multi=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Retro Obby", {Text="Retro Obby",Values={"Get Badge","Show All","Off Show All","Teleport Spawn 1","Teleport Spawn 2","Teleport Spawn 3","Click Button"},Default="",Multi=false,Callback=function(Value)
		...
		elseif (Value == "Click Button") then
			...
			elseif (game.Workspace:FindFirstChild("Retro") and game.Workspace.Retro:FindFirstChild("Map")) then
				for i, v in pairs(workspace.Retro.Map.RetroObbyMap:GetChildren()) do
					if ((v.Name == "Model") and v:FindFirstChild("StaffApp") and v.StaffApp:FindFirstChild("Button") and v.StaffApp.Button:FindFirstChild("ClickDetector")) then
						game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.StaffApp.Button.CFrame;
						wait(0.3);
	...
	Badge3Group:AddDropdown("Repressed Memory", {Text="Repressed Memory",Values={"Show All","Off Show All","Teleport Enter","Teleport Portal","Teleport Bob Plushie","Click Bob Plushie"},Default="",Multi=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Map Kraken", {Text="Map Kraken",Values={"Show All","Off Show All","Teleport Enter"},Default="",Multi=false,Callback=function(Value)
		if (Value == "Show All") then
	...
	Badge1Group:AddButton({Text="Auto Get Boxing",Func=function()
...
fireclickdetector(v.ClickDetector, 1)
	...
	Badge1Group:AddButton({Text="Auto Get Bind",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
            if not game:IsLoaded() then
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.Orb["Meshes/rock chain glove_defaultglove_cell.001"].CFrame
	...
	Badge1Group:AddButton({Text="Auto Get FrostBite",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
            if not game:IsLoaded() then
...
for i,v in ipairs(game:GetService("Workspace"):GetDescendants()) do
	...
	Badge1Group:AddButton({Text="Auto Get Admin",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
            if not game:IsLoaded() then
...
v:Disable() 
	...
	Badge1Group:AddButton({Text="Auto Get Chain",Func=function()
...
game:GetService("TeleportService"):Teleport(6403373529)
	...
	Badge1Group:AddButton({Text="Get Counter + Elude",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
        if not game:IsLoaded() then
...
fireclickdetector(v.ClickDetector)
	...
	Badge1Group:AddButton({Text="Get Swordfighter",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
        if not game:IsLoaded() then
...
fireproximityprompt(workspace.Map.Components.GloveIsland.ClaimGlove:FindFirstChild("ProximityPrompt"))
	...
	Badge1Group:AddButton({Text="Get Fight Guide",Func=function()
		local teleportFunc = queueonteleport or queue_on_teleport;
		if teleportFunc then
			teleportFunc([[
        if not game:IsLoaded() then
...
task.wait()
	...
	Badge2Group:AddButton({Text="Get Glove Kinetic",Func=function()
	...
	Badge2Group:AddButton({Text="Auto Win Kraken",Func=function()
	...
	Badge2Group:AddButton({Text="Get Glove Bomb",Func=function()
	...
	Badge2Group:AddButton({Text="Get Glove Plank",Func=function()
	...
	Badge2Group:AddButton({Text="Get Glove Blasphemy",Func=function()
	...
	Badge2Group:AddButton({Text="Auto Quests Chest All Glove",Func=function()
	...
	Badge2Group:AddButton({Text="Get Glove [Redacted]",Func=function()
	...
	Badge2Group:AddButton({Text="Voodoo + Fish + Trap Farm",Func=function()
	...
	Badge2Group:AddButton({Text="Get Duck & Orange & Knife Badge",Func=function()
	...
	Badge2Group:AddButton({Text="Get Free Ice Skate",Func=function()
	...
	Badge2Group:AddButton({Text="Get Free GRRRRR",Func=function()
	...
	Badge2Group:AddButton({Text="Get Free Lamp",Func=function()
	...
	Badge2Group:AddButton({Text="Get The Schlop",Func=function()
	...
	Badge2Group:AddButton({Text="Get Join Cheese",Func=function()
	...
	Badge2Group:AddButton({Text="Get Join Retro",Func=function()
		if (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart")) then
			if (workspace.Arena:FindFirstChild("CannonIsland") and workspace.Arena.CannonIsland:FindFirstChild("Cannon Island [OLD]")) then
				for i, v in pairs(workspace.Arena.CannonIsland:FindFirstChild("Cannon Island [OLD]"):GetChildren()) do
					if ((v.Name == "Model") and v:FindFirstChild("Towers") and v.Towers:FindFirstChild("RevealHitbox") and v.Towers:FindFirstChild("TeleportSFHitbox")) then
	...
	Badge2Group:AddToggle("Bus Stab", {Text="Bus Stab",Default=false,Callback=function(Value)
		_G.BusStab = Value;
		while _G.BusStab do
			for i, v in pairs(game.Workspace:GetChildren()) do
				if (v.Name == "BusModel") then
	...
	end}):AddKeyPicker("BusStab", {Default="Z",Text="Bus Stab",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Toolbox Farm", {Text="Toolbox Farm",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("ToolboxFarm", {Default="Z",Text="Toolbox Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Hallow Jack Farm", {Text="Hallow Jack Farm",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("HallowJackFarm", {Default="S",Text="Hallow Jack Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Phase Or Jet Farm", {Text="Phase & Jet Farm",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("PhaseOrJetFarm", {Default="U",Text="Phase & Jet Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("MATERIALIZE Farm", {Text="MATERIALIZE Farm",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("MATERIALIZEFarm", {Default="F",Text="MATERIALIZE Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Siphon Farm", {Text="Siphon Farm",Default=false,Callback=function(Value)
		_G.Siphonfarm = Value;
	...
	end}):AddKeyPicker("SiphonFarm", {Default="F",Text="Siphon Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Phase Or Jet Glitch", {Text="Phase & Jet Glitch",Default=false,Callback=function(Value)
		_G.Glitchfarm = Value;
	...
	end}):AddKeyPicker("PhaseOrJetGlitch", {Default="L",Text="Phase & Jet Glitch",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddToggle("Gift Farm", {Text="Gift Farm",Default=false,Callback=function(Value)
		_G.Giftfarm = Value;
	...
	end}):AddKeyPicker("GiftFarm", {Default="K",Text="Gift Farm",Mode="Toggle",SyncToggleState=true});
	Badge2Group:AddDropdown("Farm Brick", {Text="Farm Brick",Values={"Slow","Fast"},Default="",Multi=false,Callback=function(Value)
		_G.AutoBrick = Value;
	end});
	Badge2Group:AddToggle("AutoFram Brick", {Text="AutoFram Brick",Default=false,Callback=function(Value)
		_G.Brickfarm = Value;
	...
	Badge2Group:AddToggle("Get Tycoon", {Text="Get Tycoon",Default=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Fort Mastery", {Text="Fort Mastery",Values={"Build","Build + Break"},Default="",Multi=false,Callback=function(Value)
		_G.FortMastery = Value;
	end});
	Badge3Group:AddToggle("Auto Fort Mastery", {Text="Auto Fort Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Rob Mastery", {Text="Rob Mastery",Values={"Studs","Get Kill"},Default="",Multi=false,Callback=function(Value)
		_G.RobMastery = Value;
	end});
	local TweenRob = 1;
	Badge3Group:AddToggle("Auto Rob Mastery", {Text="Auto Rob Mastery",Default=false,Callback=function(Value)
		...
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "rob") then
			while _G.AutoRobMastery do
				if (_G.RobMastery == "Studs") then
					if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
						local TweenPlayRob = {CFrame.new(9762, 38, 10237),CFrame.new(9763, 38, 9761),CFrame.new(10241, 38, 9758),CFrame.new(10236, 38, 10236)};
	...
	Badge3Group:AddDropdown("Cloud Mastery", {Text="Cloud Mastery",Values={"Studs (200k Fly)","Afk (200 Min)","Pickup Player (100 Player)"},Default="",Multi=false,Callback=function(Value)
		_G.CloudMastery = Value;
	end});
	local TweenGet = 1;
	_G.GetPlayerSit = {};
	Badge3Group:AddToggle("Auto Cloud Mastery", {Text="Auto Cloud Mastery",Default=false,Callback=function(Value)
		...
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Cloud") then
			while _G.AutoCloudMastery do
				if (_G.CloudMastery == "Studs (200k Fly)") then
					if game.Players.LocalPlayer.Character:FindFirstChild("entered") then
						local TweenPlay = {CFrame.new(4, 113, 209),CFrame.new(228, 98, -11),CFrame.new(-9, 137, -215),CFrame.new(-229, 138, 2),CFrame.new(265, 78, 198),CFrame.new(75, -74, 48),CFrame.new(-229, 138, 2),CFrame.new(170, -90, -101),CFrame.new(-63, -88, -112),CFrame.new(-123, -77, 97),CFrame.new(110, -78, 81),CFrame.new(-367, -72, -11),CFrame.new(-497, -73, -18),CFrame.new(-437, 106, -27)};
						function NextTween()
	...
	Badge3Group:AddDropdown("Wormhole Mastery", {Text="Wormhole Mastery",Values={"Place","Teleport Time","Ambush Player"},Default="",Multi=false,Callback=function(Value)
		_G.WormholeMastery = Value;
	end});
	Badge3Group:AddToggle("Auto Wormhole Mastery", {Text="Auto Wormhole Mastery",Default=false,Callback=function(Value)
		...
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Wormhole") then
			while _G.AutoWormholeMastery do
				...
				elseif (_G.WormholeMastery == "Teleport Time") then
					game:GetService("ReplicatedStorage").WormholeTP:FireServer(CFrame.new(-57.48336410522461, -4.672852516174316, 67.94768524169922, 0.5769212245941162, 0.0005397791974246502, 0.8167997002601624, 1.468716e-7, 0.9999997615814209, -0.0006609398988075554, -0.8167998790740967, 0.00038141835830174387, 0.5769210457801819));
	...
	Badge3Group:AddDropdown("Run Mastery", {Text="Run Mastery",Values={"Esp Player","Auto Kill Player"},Default="",Multi=false,Callback=function(Value)
		_G.RunMastery = Value;
	end});
	Badge3Group:AddToggle("Auto Run Mastery", {Text="Auto Run Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Glovel Mastery", {Text="Glovel Mastery",Values={"Dip (350 Time)","Land Player"},Default="",Multi=false,Callback=function(Value)
		_G.GlovelMastery = Value;
	end});
	Badge3Group:AddToggle("Auto Glovel Mastery", {Text="Auto Glovel Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddDropdown("Bomb Mastery", {Text="Bomb Mastery",Values={"Throw Bomb","Snipe Bomb + Void","Void Kill"},Default="",Multi=false,Callback=function(Value)
		_G.BombMastery = Value;
	end});
	Badge3Group:AddToggle("Auto Bomb Mastery", {Text="Auto Bomb Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddToggle("Auto Killstreak Mastery", {Text="Auto Killstreak Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddToggle("Auto Spin Mastery", {Text="Auto Spin Mastery",Default=false,Callback=function(Value)
	...
	Badge3Group:AddToggle("Auto Brick Mastery", {Text="Auto Big Brick",Default=false,Callback=function(Value)
	...
	Local1Group:AddSlider("WalkSpeed", {Text="Speed",Default=20,Min=20,Max=1000,Rounding=0,Compact=true,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value;
		Walkspeed = Value;
	end});
	Local1Group:AddInput("WalkSpeed1", {Default="20",Numeric=false,Text="Speed",Placeholder="UserSpeed",Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Value;
		Walkspeed = Value;
	end});
	Local1Group:AddToggle("SetSpeed", {Text="Auto Set Speed",Default=false,Callback=function(Value)
		KeepWalkspeed = Value;
	...
	Local2Group:AddSlider("JumpPower", {Text="Jump",Default=50,Min=50,Max=1000,Rounding=0,Compact=true,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value;
		Jumppower = Value;
	end});
	Local2Group:AddInput("JumpPower1", {Default="50",Numeric=true,Text="Jump",Placeholder="UserJump",Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.JumpPower = Value;
		Jumppower = Value;
	end});
	Local2Group:AddToggle("SetJump", {Text="Auto Set Jump",Default=false,Callback=function(Value)
		KeepJumppower = Value;
	...
	Local3Group:AddSlider("HipHeight", {Text="Hip Height",Default=0,Min=0,Max=100,Rounding=0,Compact=true,Callback=function(Value)
		game.Players.LocalPlayer.Character.Humanoid.HipHeight = Value;
		HipHeight = Value;
	end});
	Local3Group:AddToggle("SetHipHeight", {Text="Auto Set Hip Height",Default=false,Callback=function(Value)
		KeepHipHeight = Value;
	...
	Local3Group:AddSlider("Gravity", {Text="Gravity",Default=0,Min=0,Max=100,Rounding=0,Compact=true,Callback=function(Value)
		game.Workspace.Gravity = Value;
	end});
	local Misc2Group = Tabs.Tab5:AddRightGroupbox("Misc Default");
	Misc2Group:AddDropdown("GodMobe", {Text="Godmobe",Values={"Godmode","Godmode + Invisibility"},Default="",Multi=false,Callback=function(Value)
	...
	Misc2Group:AddDropdown("Teleport Place", {Text="Teleport",Values={"Arena","Lobby","Hunter Room","Tournament","Brazil","Island Slapple","Plate","Cannon Island","Keypad","Cube Of Death","Moai Island","Default Arena","Island 1","Island 2","Island 3"},Default="",Multi=false,Callback=function(Value)
		if (Value == "Arena") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.workspace.Origo.CFrame * CFrame.new(0, -5, 0);
		...
		elseif (Value == "Island 1") then
			game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-211.210846, -5.27827597, 4.13719559, -0.0225322824, 1.8368311e-8, -0.999746144, -1.8356015e-8, 1, 1.8786684e-8, 0.999746144, 1.8774662e-8, -0.0225322824);
	...
	Misc2Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
	...
	Misc2Group:AddToggle("Auto Teleport Player", {Text="Auto Teleport Player",Default=false,Callback=function(Value)
		_G.PlayerTele = Value;
	...
	Misc2Group:AddToggle("Auto View Player", {Text="Auto View Player",Default=false,Callback=function(Value)
		_G.PlayerView = Value;
	...
	Misc2Group:AddInput("FlySpeed", {Default="50",Numeric=true,Text="Fly Speed",Placeholder="UserFlySpeed",Callback=function(Value)
		_G.SetSpeedFly = Value;
	end});
	_G.SetSpeedFly = 100;
	Misc2Group:AddToggle("Start Fly", {Text="Start Fly",Default=false,Callback=function(Value)
		_G.StartFly = Value;
	...
	end}):AddKeyPicker("Fly", {Default="R",Text="Fly",Mode="Toggle",SyncToggleState=true});
	Misc2Group:AddToggle("Button Enter Arena", {Text="Button Enter Arena (Remake)",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Autofarm Slapples", {Text="Autofarm Slapples",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("AutofarmSlapples", {Default="M",Text="Autofarm Slapples",Mode="Toggle",SyncToggleState=true});
	Misc1Basic:AddToggle("Autofarm Candy", {Text="Autofarm Candy",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("AutofarmCandy", {Default="C",Text="Toggle Anti",Mode="Toggle",SyncToggleState=true});
	Misc1Basic:AddButton({Text="Auto Keypad",DoubleClick=true,Func=function()
		if not workspace:FindFirstChild("Keypad") then
	...
	Misc1Basic:AddToggle("Auto Code Pocket Keypad", {Text="Auto Code Pocket Keypad",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddInput("Write Code Keypad", {Default="",Numeric=true,Text="Write Code Keypad",Placeholder="UserCode",Callback=function(Value)
		_G.writeCode = Value;
	end});
	Misc1Basic:AddDropdown("Enter Keypad", {Text="Enter Keypad",Values={"Not Enter","Enter"},Default="Enter",Multi=false,Callback=function(Value)
	...
	Misc1Basic:AddDropdown("Easter Egg Code", {Text="Easter Egg Code",Values={"911","8008","666","6969","1987"},Default="",Multi=false,Callback=function(Value)
		_G.EggCodes = Value;
	end});
	...
	Misc1Basic:AddToggle("Auto Farm Slap", {Text="Auto Farm Slap",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Auto Spam Ability", {Text="Auto Spam Ability",Default=false,Callback=function(Value)
		_G.OnAbility = Value;
	...
	end}):AddKeyPicker("SpamAbility", {Default="B",Text="Auto Spam Ability",Mode="Toggle",SyncToggleState=true});
	Misc1Basic:AddToggle("Spam Stun Untitled Tag", {Text="Spam Stun Untitled Tag",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Spam Ability 250 Kill", {Text="Spam Ability 250 Kill",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Infinite Rhythm", {Text="Infinite Rhythm",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Auto Slap Cherry", {Text="Slap Cherry Fast",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Free Emote", {Text="Free Emote",Default=false,Callback=function(Value)
		_G.LoadingEmote = Value;
		if not Anims then
			Anims = {L=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['L']),Groove=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Groove']),Helicopter=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Helicopter']),Floss=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Floss']),Kick=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Kick']),Headless=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Headless']),Laugh=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Laugh']),Parker=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Parker']),Thriller=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Thriller']),Spasm=game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").AnimationPack['Spasm'])};
		end
	...
	Misc1Basic:AddInput("UserGlove", {Default="",Numeric=false,Text="",Finished=true,Placeholder="UserGlove",Callback=function(Value)
		local GlovePlayer = Value;
		local Glove;
		for _, v in pairs(game.Workspace.Lobby.GloveStands:GetChildren()) do
			if (string.sub(v.Name, 1, #GlovePlayer):lower() == GlovePlayer:lower()) then
	...
	Misc1Basic:AddDropdown("ChooseEquip", {Text="Equip Glove",Values={"Normal","Tournament","Old Glove + Tournament"},Default="",Multi=false,Callback=function(Value)
	...
	Misc1Basic:AddDropdown("ArenaEnter", {Text="Enter",Values={"Arena","Arena Default"},Default="",Multi=false,Callback=function(Value)
		_G.AutoEnter = Value;
	end});
	Misc1Basic:AddToggle("Auto Enter", {Text="Auto Enter",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddSlider("Reach Aura", {Text="Reach Slap Aura",Default=25,Min=10,Max=50,Rounding=0,Compact=true,Callback=function(Value)
		_G.ReachSlapArua = Value;
	end});
	Misc1Basic:AddDropdown("Slap Friend", {Text="Slap Aura Friend",Values={"Fight","Not Fight"},Default="Fight",Multi=false,Callback=function(Value)
		_G.SlapAuraFriend = Value;
	end});
	Misc1Basic:AddDropdown("ChooseCharacter", {Text="Slap Aura Character",Values={"HumanoidRootPart","Head","Left Arm","Left Leg","Right Arm","Right Leg"},Default="HumanoidRootPart",Multi=false,Callback=function(Value)
		_G.SlapAuraCharacter = Value;
	end});
	Misc1Basic:AddDropdown("Slap Aura Choose", {Text="Slap Aura Choose",Values={"Normal","Reverse"},Default="Normal",Multi=false,Callback=function(Value)
		_G.SlapAuraChoose = Value;
	end});
	Misc1Basic:AddToggle("Slap Aura", {Text="Slap Aura",Default=false,Callback=function(Value)
		_G.SlapAura = Value;
	...
	end}):AddKeyPicker("SlapAura", {Default="H",Text="Slap Aura",Mode="Toggle",SyncToggleState=true});
	_G.ReachShukuchi = 50;
	_G.ShukuchiFriend = "Fight";
	Misc1Basic:AddSlider("Reach Shukuchi", {Text="Reach Shukuchi",Default=50,Min=1,Max=130,Rounding=0,Compact=true,Callback=function(Value)
		_G.ReachShukuchi = Value;
	end});
	Misc1Basic:AddDropdown("Shukuchi Friend", {Text="Shukuchi Friend",Values={"Fight","Not Fight"},Default="Fight",Multi=false,Callback=function(Value)
		_G.ShukuchiFriend = Value;
	end});
	Misc1Basic:AddToggle("Auto Shukuchi Player", {Text="Auto Shukuchi Player",Default=false,Callback=function(Value)
	...
	_G.ReachHitbox = 10;
	Misc1Basic:AddSlider("Reach HitBox", {Text="Reach Hitbox",Default=10,Min=10,Max=30,Rounding=0,Compact=true,Callback=function(Value)
		_G.ReachHitbox = Value;
	end});
	Misc1Basic:AddToggle("Hitbox Player Mod", {Text="Hitbox Player & Mod",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("Hitbox", {Default="Z",Text="Hitbox Player & Mod",Mode="Toggle",SyncToggleState=true});
	_G.GloveExtendReach = 5;
	Misc1Basic:AddSlider("Extend Glove", {Text="Extend Glove",Default=5,Min=2,Max=20,Rounding=0,Compact=true,Callback=function(Value)
		_G.GloveExtendReach = Value;
	end});
	Misc1Basic:AddDropdown("Extend Option", {Text="Extend Option",Values={"Meat Stick","Pancake","Growth","North Korea Wall","Slight Extend"},Default="",Multi=false,Callback=function(Value)
		GloveExtendOption = Value;
	end});
	Misc1Basic:AddToggle("Extend Glove", {Text="Extend Glove",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("ExtendGlove", {Default="C",Text="Extend Glove",Mode="Toggle",SyncToggleState=true});
	Misc1Basic:AddInput("Auto Change Nametag", {Default="Auto Change Nametag",Numeric=false,Text="",Placeholder="Change",Callback=function(Value)
		game.Workspace.NametagChanged.Value = Value;
	end});
	Misc1Basic:AddToggle("NameTag", {Text="Auto Set NameTag",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddInput("Auto Change Slap", {Default="Auto Change Slap",Numeric=false,Text="",Placeholder="Change",Callback=function(Value)
		game.Workspace.NametagChanged.SlapChanged.Value = Value;
	end});
	Misc1Basic:AddToggle("SlapFake", {Text="Auto Set Slap",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddInput("Auto Change Glove", {Default="Auto Change Glove",Numeric=false,Text="",Placeholder="Change",Callback=function(Value)
		game.Workspace.NametagChanged.GloveChanged.Value = Value;
	end});
	Misc1Basic:AddToggle("GloveFake", {Text="Auto Set Glove",Default=false,Callback=function(Value)
		_G.AutoChangeSlapFake = Value;
		while _G.AutoChangeSlapFake do
	...
	Misc1Basic:AddDropdown("Tycoon", {Text="Tycoon",Values={"All","Your"},Default="All",Multi=false,Callback=function(Value)
		_G.TycoonAuto = Value;
	end});
	Misc1Basic:AddToggle("Click Tycoon", {Text="Auto Click Tycoon",Default=false,Callback=function(Value)
	...
	Misc1Basic:AddToggle("Auto Destroy Tycoon", {Text="Auto Destroy Tycoon",Default=false,Callback=function(Value)
	...
	Misc2Esp:AddToggle("Esp Glove", {Text="Esp Glove",Default=false,Callback=function(Value)
		_G.GloveESP = Value;
	...
	end}):AddColorPicker("Color Esp", {Default=Color3.new(255, 255, 255),Callback=function(Value)
		_G.ColorESP = Value;
	end}):AddKeyPicker("EspGlove", {Default="T",Text="Esp Glove",Mode="Toggle",SyncToggleState=true});
	_G.DistanceEsp = false;
	Misc2Esp:AddToggle("Distance Esp", {Text="Distance Esp",Default=false,Callback=function(Value)
		_G.DistanceEsp = Value;
	end});
	_G.GloveEsp = false;
	Misc2Esp:AddToggle("Glove Esp", {Text="Glove Esp",Default=false,Callback=function(Value)
		_G.GloveEsp = Value;
	end});
	_G.SlapEsp = false;
	Misc2Esp:AddToggle("Slap Esp", {Text="Slap Esp",Default=false,Callback=function(Value)
		_G.SlapEsp = Value;
	end});
	_G.NameEsp = false;
	Misc2Esp:AddToggle("Name Esp", {Text="Name Esp",Default=false,Callback=function(Value)
		_G.NameEsp = Value;
	end});
	_G.GhostEsp = false;
	Misc2Esp:AddToggle("Ghost Esp", {Text="Ghost Esp",Default=false,Callback=function(Value)
		_G.GhostEsp = Value;
	end});
	_G.HighlightEsp = false;
	Misc2Esp:AddToggle("Highlight Esp", {Text="Highlight Esp",Default=false,Callback=function(Value)
		_G.HighlightEsp = Value;
	end});
	_G.TextSize = 10;
	Misc2Esp:AddSlider("Size Text Esp", {Text="Size Text Esp",Default=10,Min=10,Max=40,Rounding=0,Compact=true,Callback=function(Value)
		_G.TextSize = Value;
		for i, v in ipairs(game.Players:GetChildren()) do
	...
	Misc3Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
		_G.PlayerTarget = Value;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #_G.PlayerTarget):lower() == _G.PlayerTarget:lower()) then
				PlayerTa = v;
	...
	Misc3Group:AddDropdown("Retro", {Text="Retro",Values={"Get Retro","Teleport Button","Enter Retro"},Default="",Multi=false,Callback=function(Value)
	...
	Misc3Group:AddSlider("Time Help Berserk", {Text="Time Help Berserk",Default=3,Min=1,Max=3,Rounding=0,Callback=function(Value)
		_G.TimeHelpGotIm = Value;
	end});
	Misc3Group:AddDropdown("Will Teleport Help", {Text="Will Teleport Help",Values={"Up To You","SafeSpotBox 1.0","SafeSpotBox 2.0"},Default="",Multi=false,Callback=function(Value)
		...
		if ((game.Players.LocalPlayer.leaderstats.Glove.Value == "Kinetic") and game.Players.LocalPlayer.Character:FindFirstChild("entered") and game.Players[_G.PlayerPut1].Character:FindFirstChild("entered")) then
			for o = 1, _G.TimeHelpGotIm do
				...
				elseif ((_G.GetTeleportHelp == "SafeSpotBox 1.0") or (_G.GetTeleportHelp == "SafeSpotBox 2.0")) then
					game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players[_G.PlayerPut1].Character.Head.CFrame * CFrame.new(0, 5.8, 0);
				end
				wait(0.28);
				if game.Players.LocalPlayer.Backpack:FindFirstChild("Kinetic") then
					game.Players.LocalPlayer.Character.Humanoid:EquipTool(game.Players.LocalPlayer.Backpack.Kinetic);
	...
	Glove1Group:AddDropdown("Prop", {Text="Prop Ability",Values={"Barrel","Bench","Brick","Bush 1","Bush 2","Cauldron","Diamond","Frenzy Bot","Gift","GoldenSlapple","Imp","Jet Orb","Larry","MEGAROCK","Moai Head","Obby 1","Obby 2","Obby 3","Obby 4","Obby 5","Orange","Oven","Phase Heart","Phase Orb","Rock 1","Rock 2","Rock 3","Sentry","Slapple","Snow Peep","Snow Turret","bob","rob","Sbeve"},Default="",Multi=false,Callback=function(Value)
		PropAbility = Value;
	end});
	Glove1Group:AddToggle("Spam Prop", {Text="Auto Ability Prop",Default=false,Callback=function(Value)
		_G.PropSpam = Value;
	...
	Glove1Group:AddDropdown("Santa", {Text="Santa Ability",Values={"Bob Plush","Snow Peep","Milk"},Default="",Multi=false,Callback=function(Value)
		SantaAbility = Value;
	end});
	Glove1Group:AddToggle("Spam Santa", {Text="Auto Ability Santa",Default=false,Callback=function(Value)
		SantaSpam = Value;
	...
	Glove1Group:AddDropdown("AdminAbility", {Text="Admin Ability",Values={"Fling","Anvil","Invisibility"},Default="",Multi=false,Callback=function(Value)
		AbilityAdmin = Value;
	end});
	Glove1Group:AddToggle("Spam Admin", {Text="Auto Ability Admin",Default=false,Callback=function(Value)
		AdminSpam = Value;
		while AdminSpam do
	...
	Glove1Group:AddDropdown("RetroAbility", {Text="Retro Ability",Values={"Rocket Launcher","Ban Hammer","Bomb"},Default="",Multi=false,Callback=function(Value)
		RetroAbility = Value;
	end});
	Glove1Group:AddToggle("Spam Retro", {Text="Auto Ability Retro",Default=false,Callback=function(Value)
		RetroSpam = Value;
		while RetroSpam do
	...
	Glove1Group:AddDropdown("SlapStickAbility", {Text="SlapStick Ability",Values={"runeffect","fullcharged","dash","addarm","charge","cancelrun","discharge"},Default="",Multi=false,Callback=function(Value)
		SlapstickAbility = Value;
	end});
	Glove1Group:AddToggle("Spam Slapstick", {Text="Auto Ability Slapstick",Default=false,Callback=function(Value)
		SlapstickSpam = Value;
	...
	Glove1Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
	...
	Glove1Group:AddToggle("Godmobe Player", {Text="Auto Godmobe Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddDropdown("RojoAbility", {Text="Rojo Ability",Values={"Normal","Down"},Default="",Multi=false,Callback=function(Value)
		RojoAbility = Value;
	end});
	Glove1Group:AddToggle("RojoAbility", {Text="Auto Ability Rojo",Default=false,Callback=function(Value)
		if (Person == nil) then
			Person = game.Players.LocalPlayer.Name;
		end
		_G.RojoSpam = Value;
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Rojo") then
			while _G.RojoSpam do
				...
				elseif (RojoAbility == "Down") then
					game:GetService("ReplicatedStorage"):WaitForChild("RojoAbility"):FireServer("Release", {(game.Players[Person].Character.HumanoidRootPart.CFrame * CFrame.Angles(-1.5, -1e-8, -0.5663706660270691))});
				end
				task.wait();
			end
	...
	Glove1Group:AddSlider("ChargeExplosion", {Text="Charge Explosion",Default=20,Min=20,Max=100,Rounding=0,Compact=true,Callback=function(Value)
		_G.ChargeExplosion = Value;
	end});
	Glove1Group:AddToggle("Ability Divebomb", {Text="Auto Ability Divebomb",Default=false,Callback=function(Value)
	...
	Glove1Group:AddToggle("AbilityBarrelPlayer", {Text="Auto Barrel Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddDropdown("BindAbility", {Text="Bind Ability",Values={"Default","Ultimate"},Default="",Multi=false,Callback=function(Value)
		_G.BindAbility = Value;
	end});
	Glove1Group:AddToggle("AbilityBindPlayer", {Text="Auto Bind Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddDropdown("PlayerChoose", {Text="Player Choose",Values={"Username","Random"},Default="",Multi=false,Callback=function(Value)
	...
	Glove1Group:AddDropdown("Teleport Old Place", {Text="Teleport Old Place",Values={"Yes","No","Player"},Default="Yes",Multi=false,Callback=function(Value)
	...
	Glove1Group:AddToggle("Auto Oven Player", {Text="Auto Oven Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddToggle("Auto Siphon Player", {Text="Auto Siphon Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddToggle("Auto Sbeve All Player", {Text="Auto Sbeve All Player",Default=false,Callback=function(Value)
	...
	Glove1Group:AddDropdown("Black Hole", {Text="Black Hole",Values={"Normal","Teleport Cannon Island"},Default="",Multi=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Auto Collect Ingredients", {Text="Auto Collect Ingredients",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Auto Collect Pillow", {Text="Auto Collect Pillow",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Infinity Pillow", {Text="Infinity Pillow",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Infinite Ingredients", {Text="Infinite Ingredients",Default=false,Callback=function(Value)
	...
	Glove2Group:AddDropdown("Potion", {Text="Potion",Values={"Grug","Nightmare","Confusion","Power","Paralyzing","Haste","Invisibility","Explosion","Invincible","Toxic","Freeze","Feather","Speed","Lethal","Slow","Antitoxin","Corrupted Vine","Field","Lost"},Default="",Multi=false,Callback=function(Value)
		_G.MakePotion = Value;
	end});
	Glove2Group:AddSlider("Potion1", {Text="Potion",Default=1,Min=1,Max=100,Rounding=0,Compact=true,Callback=function(Value)
		_G.PotionNumber = Value;
	end});
	Glove2Group:AddDropdown("Potion2", {Text="Potion",Values={"Number","Normal"},Default="",Multi=false,Callback=function(Value)
		_G.Potion2 = Value;
	end});
	...
	Glove2Group:AddToggle("Auto Get Potion", {Text="Auto Get Potion",Default=false,Callback=function(Value)
	...
	Glove2Group:AddInput("Players", {Default="",Numeric=false,Text="",Finished=true,Placeholder="Username",Callback=function(Value)
		_G.PlayerTarget = Value;
		for _, v in pairs(game.Players:GetPlayers()) do
			if (string.sub(v.Name, 1, #_G.PlayerTarget):lower() == _G.PlayerTarget:lower()) then
				PlayerTa = v;
	...
	Glove2Group:AddInput("SpeedOrbit", {Default="20",Numeric=false,Text="Speed",Placeholder="UserSpeed",Callback=function(Value)
	...
	Glove2Group:AddSlider("Extend", {Text="Extend Ability",Default=0,Min=0,Max=100,Rounding=0,Compact=true,Callback=function(Value)
		_G.ExtendPingPong = Value;
	end});
	Glove2Group:AddDropdown("Clone", {Text="Clone",Values={"Orbit","Orbit Player"},Default="",Multi=false,Callback=function(Value)
		_G.Clone = Value;
	end});
	Glove2Group:AddToggle("Auto Clone", {Text="Auto Clone",Default=false,Callback=function(Value)
		_G.CloneAuto = Value;
	...
	Glove2Group:AddDropdown("Ping Pong Choose", {Text="Ping Pong",Values={"Fling","Fling Player","Orbit","Orbit Player","Nuke"},Default="",Multi=false,Callback=function(Value)
		_G.PingPongServer = Value;
	end});
	Glove2Group:AddToggle("PingPong", {Text="Ping Pong",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Auto Fight Ping Pong", {Text="Auto Fight Ping Pong",Default=false,Callback=function(Value)
	...
	Glove2Group:AddDropdown("GloveFarm", {Text="Equipped Glove Farm",Values={"Baller","Replica","Blink"},Default="",Multi=false,Callback=function(Value)
		if (game.Players.LocalPlayer.Character:FindFirstChild("entered") == nil) then
	...
	Glove2Group:AddDropdown("SafeFarm", {Text="Will Teleport Farm",Values={"Up To You","SafeSpotBox 1.0","SafeSpotBox 2.0"},Default="SafeSpotBox 1.0",Multi=false,Callback=function(Value)
		_G.GetTeleport = Value;
	end});
	_G.FarmSlap = "Replica + Baller";
	Glove2Group:AddDropdown("AutoFarm Slap", {Text="Slap Farm",Values={"Replica + Baller","Replica + Baller + Blink","Baller","Replica","Blink"},Default="Replica + Baller",Multi=false,Callback=function(Value)
		_G.FarmSlap = Value;
	end});
	Glove2Group:AddToggle("SlapFarm", {Text="Slap Farm",Default=false,Callback=function(Value)
		_G.AutoFarmSlap = Value;
		if (_G.AutoFarmSlap == true) then
	...
	Glove2Group:AddSlider("ExtendRob", {Text="Extend HitBox Rob",Default=16,Min=16,Max=400,Rounding=1,Compact=true,Callback=function(Value)
		_G.ExtendHitboxRob = Value;
	end});
	Glove2Group:AddDropdown("Hitbox Rob", {Text="Hitbox Rob",Values={"You","All"},Default="All",Multi=false,Callback=function(Value)
		_G.RobHitbox = Value;
	end});
	Glove2Group:AddToggle("Hitbox Rob", {Text="Hitbox All Rob & Color",Default=false,Callback=function(Value)
		_G.HitboxRob = Value;
	...
	end}):AddColorPicker("Color Hitbox Rob", {Default=Color3.new(255, 255, 255),Callback=function(Value)
		_G.ColorHitboxRob = Value;
	end});
	_G.SetSpeedFlyCloud = 2;
	Glove2Group:AddInput("FlySpeed", {Default="2",Numeric=true,Text="Fly Speed Cloud",Placeholder="UserFlySpeed",Callback=function(Value)
		_G.SetSpeedFlyCloud = Value;
	end});
	Glove2Group:AddToggle("Cloud Speed", {Text="Cloud Speed",Default=false,Callback=function(Value)
		_G.CloudSpeed = Value;
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Cloud") then
	...
	Glove2Group:AddDropdown("Cloud Bring", {Text="Cloud Bring",Values={"Player","Your"},Default="Player",Multi=false,Callback=function(Value)
		_G.CloudBring = Value;
	end});
	Glove2Group:AddToggle("Auto Bring Cloud", {Text="Auto Bring Cloud",Default=false,Callback=function(Value)
		_G.BringCloud = Value;
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Cloud") then
	...
	Glove2Group:AddDropdown("Firework Bring", {Text="Firework Bring",Values={"Player","Your"},Default="Player",Multi=false,Callback=function(Value)
		_G.FireworkBring = Value;
	end});
	Glove2Group:AddToggle("Auto Bring Firework", {Text="Auto Bring Firework",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Auto Full Kinetic", {Text="Auto Full Kinetic",Default=false,Callback=function(Value)
	...
	Glove2Group:AddToggle("Auto Color Skin", {Text="Auto Color Skin",Default=false,Callback=function(Value)
		_G.GoldColor = Value;
	...
	end}):AddColorPicker("Color Skin", {Default=Color3.new(255, 255, 255),Callback=function(Value)
		_G.skinColor = Value;
	end});
	Glove2Group:AddToggle("Auto Rainbow", {Text="Auto Rainbow",Default=false,Callback=function(Value)
		_G.Rainbow = Value;
		if (game.Players.LocalPlayer.leaderstats.Glove.Value == "Golden") then
...
elseif (game.PlaceId == 11828384869) then
	local Window = Library:CreateWindow({Title="erere - Maze 👁️",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
...
elseif (game.PlaceId == 13833961666) then
	local Window = Library:CreateWindow({Title="rere - Boss Bob 💥",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	if (workspace:FindFirstChild("VoidPart") == nil) then
		local VoidPart = Instance.new("Part", workspace);
		VoidPart.Name = "VoidPart";
	...
	Tabs = {Tab=Window:AddTab("Script", "rbxassetid://8997387937"),Tab1=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	...
	Misc1Group:AddToggle("Auto Set Info", {Text="Auto Set Info",Default=false,Callback=function(Value)
	...
	Misc2Group:AddToggle("Damage Boss", {Text="Damage Boss",Default=false,Callback=function(Value)
	...
	Misc2Group:AddToggle("Auto Click Tycoon", {Text="Auto Click Tycoon",Default=false,Callback=function(Value)
		_G.AutoTycoon = Value;
	...
	Misc2Group:AddDropdown("Glove", {Text="Glove",Values={"Killstreak","Reaper","God's Hand","Tycoon"},Default="Player",Multi=false,Callback=function(Value)
		GloveSlap = Value;
	end});
	Misc2Group:AddToggle("Slap Aura Bob Mini", {Text="Slap Aura Bob Mini",Default=false,Callback=function(Value)
	...
	Misc2Group:AddSlider("Hitbox Bobs", {Text="Hitbox Bob",Default=10,Min=50,Max=80,Rounding=0,Compact=false,Callback=function(Value)
		_G.HitboxBob = Value;
	end});
	Misc2Group:AddToggle("Hitbox Bob Mini", {Text="Hitbox Bob Mini",Default=false,Callback=function(Value)
	...
	Misc3Group:AddToggle("Anti Ring", {Text="Anti Ring",Default=false,Callback=function(Value)
		_G.AntiRing = Value;
	...
	end}):AddKeyPicker("AntiRing", {Default="X",Text="Anti Ring",Mode="Toggle",SyncToggleState=true});
	Misc3Group:AddToggle("Remove Meteors", {Text="Remove Meteors",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("RemoveMeteors", {Default="X",Text="Remove Big Meteors",Mode="Toggle",SyncToggleState=true});
	Misc3Group:AddToggle("Anti Void Damage", {Text="Anti Void Damage",Default=false,Callback=function(Value)
		game.Workspace['VoidPart'].CanCollide = Value;
		if (Value == true) then
	...
	end}):AddKeyPicker("AntiVoidDamage", {Default="X",Text="Anti Void Damage",Mode="Toggle",SyncToggleState=true});
	Misc3Group:AddToggle("Anti Ragdoll", {Text="Anti Ragdoll",Default=false,Callback=function(Value)
		_G.AntiRagdoll = Value;
		while _G.AntiRagdoll do
	...
	end}):AddKeyPicker("AntiRagdoll", {Default="X",Text="Anti Ragdoll",Mode="Toggle",SyncToggleState=true});
elseif (game.PlaceId == 9431156611) then
	local Window = Library:CreateWindow({Title="erer - Slap Royale 👏",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Combat", "rbxassetid://7733674079"),Tab1=Window:AddTab("Anti", "rbxassetid://7734056608"),Tab2=Window:AddTab("Misc", "rbxassetid://4370318685"),Tab3=Window:AddTab("Local", "rbxassetid://4335489011"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	TabBoxCombat1 = Tabs.Tab:AddLeftTabbox();
	local Combat1Group = TabBoxCombat1:AddTab("Combat");
	_G.ReachAura = 25;
	Combat1Group:AddSlider("Reach Slap", {Text="Reach Slap Aura",Default=25,Min=10,Max=50,Rounding=1,Compact=true,Callback=function(Value)
		_G.ReachAura = Value;
	end});
	_G.SlapAuraChoose = "Click Slap";
	Combat1Group:AddDropdown("ChooseSlap", {Text="Slap Aura",Values={"Slap Aura","Click Slap"},Default="Click Slap",Multi=false,Callback=function(Value)
		_G.SlapAuraChoose = Value;
	end});
	Combat1Group:AddToggle("Slap Aura", {Text="Slap Aura",Default=false,Callback=function(Value)
		_G.SlapAura = Value;
	...
	end}):AddKeyPicker("SlapAura", {Default="F",Text="Slap Aura",Mode="Toggle",SyncToggleState=true});
	Combat1Group:AddSlider("Extend Glove", {Text="Extend Glove",Default=5,Min=2,Max=50,Rounding=1,Compact=true,Callback=function(Value)
		_G.GloveExtendReach = Value;
	end});
	Combat1Group:AddDropdown("Extend Option", {Text="Extend Option",Values={"Meat Stick","Pancake","Growth","North Korea Wall","Slight Extend"},Default="",Multi=false,Callback=function(Value)
		GloveExtendOption = Value;
	end});
	Combat1Group:AddToggle("Extend Glove", {Text="Extend Glove",Default=false,Callback=function(Value)
		_G.GloveExtendGet = Value;
		while _G.GloveExtendGet do
	...
	end}):AddKeyPicker("ExtendGlove", {Default="H",Text="Extend Glove",Mode="Toggle",SyncToggleState=true});
	_G.ReachHitbox = 10;
	Combat1Group:AddSlider("Reach HitBox", {Text="Reach Hitbox",Default=10,Min=10,Max=30,Rounding=0,Compact=true,Callback=function(Value)
		_G.ReachHitbox = Value;
	end});
	Combat1Group:AddToggle("Hitbox Player", {Text="Hitbox Player",Default=false,Callback=function(Value)
		_G.HitboxPlayer = Value;
		while _G.HitboxPlayer do
			for i, v in pairs(game.Players:GetChildren()) do
				if ((v ~= game.Players.LocalPlayer) and v.Character and v.Character:FindFirstChild("HumanoidRootPart")) then
	...
	end}):AddKeyPicker("Hitbox", {Default="Z",Text="Hitbox Player",Mode="Toggle",SyncToggleState=true});
	Combat1Group:AddInput("FlySpeed", {Default="50",Numeric=true,Text="Fly Speed",Placeholder="UserFlySpeed",Callback=function(Value)
		_G.SetSpeedFly = Value;
	end});
	_G.SetSpeedFly = 100;
	Combat1Group:AddToggle("Start Fly", {Text="Start Fly",Default=false,Callback=function(Value)
		_G.StartFly = Value;
		if (_G.StartFly == false) then
			if (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.RootPart and game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("VelocityHandler") and game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("GyroHandler")) then
				game.Players.LocalPlayer.Character.HumanoidRootPart.VelocityHandler:Destroy();
	...
	Combat1Group:AddButton({Text="Leave Bus Early",DoubleClick=true,Tooltip="People Vote You",Func=function()
	...
	Combat2Group:AddToggle("Auto Use Item Power", {Text="Auto Use Item Power",Default=false,Callback=function(Value)
	...
	Esp1Group:AddToggle("Esp", {Text="Glove Esp",Default=false,Callback=function(Value)
		_G.GloveESP = Value;
		if (_G.GloveESP == false) then
			for i, v in ipairs(game.Players:GetChildren()) do
	...
	end}):AddColorPicker("Color Esp Glove", {Default=Color3.new(255, 255, 255),Callback=function(Value)
		_G.ColorESP = Value;
	end}):AddKeyPicker("GloveEsp", {Default="B",Text="Glove Esp",Mode="Toggle",SyncToggleState=true});
	_G.NameEsp = false;
	Esp1Group:AddToggle("Name Esp", {Text="Name Player Esp",Default=false,Callback=function(Value)
		_G.NameEsp = Value;
	end});
	Esp1Group:AddToggle("Esp1", {Text="Item Esp",Default=false,Callback=function(Value)
		_G.ItemESP = Value;
	...
	end}):AddColorPicker("Color Esp Item", {Default=Color3.new(255, 255, 255),Callback=function(Value)
		_G.ColorESP1 = Value;
	end}):AddKeyPicker("ItemEsp", {Default="L",Text="Item Esp",Mode="Toggle",SyncToggleState=true});
	_G.DistanceEsp = false;
	Esp1Group:AddToggle("Distance Esp", {Text="Distance Esp",Default=false,Callback=function(Value)
		_G.DistanceEsp = Value;
	end});
	_G.TextSize = 10;
	Esp1Group:AddSlider("Size Text Esp", {Text="Size Text Esp",Default=10,Min=10,Max=40,Rounding=0,Compact=true,Callback=function(Value)
		_G.TextSize = Value;
		for i, v in ipairs(game.Players:GetChildren()) do
			if (v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("GloveEsp") and v.Character.Head.GloveEsp:FindFirstChild("TextLabel") and (v.Character.Head.GloveEsp.TextLabel.TextSize ~= Value)) then
				v.Character.Head.GloveEsp.TextLabel.TextSize = Value;
	...
	Anti1Group:AddToggle("Anti Zone", {Text="Anti Zone",Default=false,Callback=function(Value)
		_G.RemoveZone = Value;
	...
	end}):AddKeyPicker("AntiZone", {Default="K",Text="Anti Zone",Mode="Toggle",SyncToggleState=true});
	Anti1Group:AddToggle("Anti Ice", {Text="Anti Ice",Default=false,Callback=function(Value)
		_G.AntiIce = Value;
		while _G.AntiIce do
			for i, v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
				if (v.Name == "Icecube") then
	...
	end}):AddKeyPicker("AntiIce", {Default="K",Text="Anti Ice",Mode="Toggle",SyncToggleState=true});
	Anti1Group:AddToggle("Anti Lava Acid", {Text="Anti Lava & Acid",Default=false,Callback=function(Value)
		game.Workspace['AntiLava'].CanCollide = Value;
		game.Workspace['AntiLava']['AntiAcid'].CanCollide = Value;
	end}):AddKeyPicker("AntiLavaAcid", {Default="K",Text="Anti Lava & Acid",Mode="Toggle",SyncToggleState=true});
	Anti1Group:AddToggle("Anti Record", {Text="Anti Record",Default=false,Tooltip="People chat record, you get kick",Callback=function(Value)
		AntiRecord = Value;
	end}):AddKeyPicker("AntiRecord", {Default="K",Text="Anti Record",Mode="Toggle",SyncToggleState=true});
	for i, p in pairs(game.Players:GetChildren()) do
		if (p ~= game.Players.LocalPlayer) then
			p.Chatted:Connect(function(message)
				Words = message:split(" ");
	...
	Anti1Group:AddToggle("Anti Ragdoll", {Text="Anti Ragdoll",Default=false,Callback=function(Value)
		_G.AntiRagdoll = Value;
		while _G.AntiRagdoll do
			if (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart")) then
				if (game.Players.LocalPlayer.Character:WaitForChild("Ragdolled").Value == true) then
	...
	end}):AddKeyPicker("AntiRagdoll", {Default="K",Text="Anti Ragdoll",Mode="Toggle",SyncToggleState=true});
...
elseif (game.PlaceId == 14422118326) then
	local Window = Library:CreateWindow({Title="rere - Maze Null",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Misc");
	Misc1Group:AddToggle("Anti Null", {Text="Anti Null",Default=false,Callback=function(Value)
		_G.AntiNull = Value;
		while _G.AntiNull do
	...
	Misc1Group:AddInput("FlySpeed", {Default="50",Numeric=true,Text="Fly Speed",Placeholder="UserFlySpeed",Callback=function(Value)
		_G.SetSpeedFly = Value;
	end});
	_G.SetSpeedFly = 100;
	Misc1Group:AddToggle("Start Fly", {Text="Start Fly",Default=false,Callback=function(Value)
		_G.StartFly = Value;
		if (_G.StartFly == false) then
			if (game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid") and game.Players.LocalPlayer.Character.Humanoid.RootPart and game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("VelocityHandler") and game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("GyroHandler")) then
				game.Players.LocalPlayer.Character.HumanoidRootPart.VelocityHandler:Destroy();
	...
	Misc1Group:AddDropdown("Badge", {Text="Badge",Values={"Tinkever","Null"},Default="",Multi=false,Callback=function(Value)
		if (Value == "Null") then
...
elseif (game.PlaceId == 16034567693) then
	local Window = Library:CreateWindow({Title="rrr - ADMIN ROOM",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	...
	AgeAccYou = InfoServer1Group:AddLabel("You Account Age [ " .. game.Players.LocalPlayer.AccountAge .. " ]", true);
	InfoServer1Group:AddToggle("Toggle Set", {Text="Toggle Return",Default=false,Callback=function(Value)
		_G.AutoSetInfo = Value;
		if (_G.AutoSetInfo == true) then
			AutoSetInfoServer = game:GetService("RunService").RenderStepped:Connect(function()
				if (_G.AutoSetInfo == true) then
	...
	Misc2Group:AddToggle("Anti Afk", {Text="Anti Afk",Default=false,Callback=function(Value)
		_G.AntiAfk = Value;
		for i, v in next, getconnections(game.Players.LocalPlayer.Idled) do
			if _G.AntiAfk then
				v:Disable();
...
elseif (game.PlaceId == 17290438723) then
	local Window = Library:CreateWindow({Title="erere - Frostbite Map Obby",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Misc");
...
elseif (game.PlaceId == 18550498098) then
	local Window = Library:CreateWindow({Title="erer - Boss Guide",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	...
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),Tab1=Window:AddTab("Anti", "rbxassetid://7734056608"),Tab2=Window:AddTab("Local", "rbxassetid://4335489011"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	...
	Misc2Group:AddToggle("Fight Trask", {Text="Fight Trask",Default=false,Callback=function(Value)
		_G.BringTrask = Value;
	...
	end}):AddKeyPicker("FightTrask", {Default="V",Text="Fight Trask",Mode="Toggle",SyncToggleState=true});
	Misc2Group:AddToggle("Fight Boss Final", {Text="Fight Boss Final",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("FightBossFinal", {Default="V",Text="Fight Boss Final",Mode="Toggle",SyncToggleState=true});
	Misc2Group:AddToggle("Fight Replica", {Text="Fight Replica",Default=false,Callback=function(Value)
	...
	end}):AddKeyPicker("FightReplica", {Default="V",Text="Fight Replica",Mode="Toggle",SyncToggleState=true});
	Misc2Group:AddToggle("Fight Golem", {Text="Fight Golem",Default=false,Callback=function(Value)
		_G.FightGolem = Value;
	...
	end}):AddKeyPicker("FightGolem", {Default="V",Text="Fight Golem",Mode="Toggle",SyncToggleState=true});
	Misc2Group:AddToggle("Fight All", {Text="Fight All",Default=false,Callback=function(Value)
		_G.FightAll = Value;
	...
	end}):AddKeyPicker("FightAll", {Default="O",Text="Fight All",Mode="Toggle",SyncToggleState=true});
	...
	local Anti1Group = Tabs.Tab1:AddLeftGroupbox("Anti");
	Anti1Group:AddToggle("Anti Void", {Text="Anti Void",Default=false,Callback=function(Value)
		game.Workspace.VoidPart.CanCollide = Value;
		if (Value == true) then
			game.Workspace.VoidPart.Transparency = 0.5;
		else
	...
	Anti1Group:AddToggle("Anti Sbeve", {Text="Anti Sbeve",Default=false,Callback=function(Value)
		_G.AntiSbeve = Value;
	...
	Anti1Group:AddToggle("Anti Wall", {Text="Anti Wall",Default=false,Callback=function(Value)
		_G.AntiWall = Value;
...
elseif (game.PlaceId == 7234087065) then
	local Window = Library:CreateWindow({Title="ere - Lobby OGG",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Prepare");
	...
	Misc1Group:AddToggle("Auto Tp Clock", {Text="Auto Teleport Clock",Default=false,Callback=function(Value)
...
elseif (game.PlaceId == 74169485398268) then
	local Window = Library:CreateWindow({Title="rere - Maze Bind",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
...
elseif (game.PlaceId == 102908326578005) then
	local Window = Library:CreateWindow({Title="erer - OGG Home Jorgis",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Misc");
...
elseif (game.PlaceId == 115782629143468) then
	local Window = Library:CreateWindow({Title="erer - TOH",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Misc");
	Misc1Group:AddButton("Teleport Badge", function()
...
elseif (game.PlaceId == 92516899071319) then
	local Window = Library:CreateWindow({Title="ee - Sleep Map",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Misc", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Misc");
	Misc1Group:AddToggle("Auto Collect Pillow", {Text="Auto Collect Pillow",Default=false,Callback=function(Value)
		_G.AutoCollectPillow = Value;
		while _G.AutoCollectPillow do
...
elseif (game.PlaceId == 118650724506449) then
	local Window = Library:CreateWindow({Title="ee - Bad Dreams",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Main", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
...
elseif (game.PlaceId == 97220865182663) then
	local Window = Library:CreateWindow({Title="ee - Boss Mouse",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	if (workspace.Game:FindFirstChild("Buildings") and workspace.Game.Buildings:FindFirstChild("City") and (workspace.Game.Buildings.City:FindFirstChild("City") == nil)) then
		game:GetService("ReplicatedStorage").Remotes.PlaceBuilding:FireServer("City", Vector3.new(4.656613e-9, 43.496280670166016, -45), 0);
	end
	Tabs = {Tab=Window:AddTab("Main", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	...
	Misc1Group:AddToggle("Auto Slap Rat", {Text="Auto Slap Rat",Default=false,Callback=function(Value)
	...
	Misc1Group:AddToggle("AutoFarm Apple", {Text="AutoFarm Apple",Default=false,Callback=function(Value)
...
elseif (game.PlaceId == 98726100529621) then
	local Window = Library:CreateWindow({Title="urin - Map Obby Hexa",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Main", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Badge");
...
elseif (game.PlaceId == 136005148166028) then
	local Window = Library:CreateWindow({Title="ee - Map Designer Roblox",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Main", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Badge");
...
elseif (game.PlaceId == 117232463555132) then
	local Window = Library:CreateWindow({Title="eee - Map Retro Boss",Center=true,AutoShow=true,Resizable=true,AutoLock=true,ShowCustomCursor=true,NotifySide="Right",TabPadding=2,MenuFadeTime=0});
	Tabs = {Tab=Window:AddTab("Main", "rbxassetid://4370318685"),["UI Settings"]=Window:AddTab("UI Settings", "rbxassetid://7733955511")};
	local Misc1Group = Tabs.Tab:AddLeftGroupbox("Badge");
	Misc1Group:AddButton("Get Badge", function()
		if game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
...
MenuGroup:AddDropdown("NotifySide", {Text="Notification Side",Values={"Left","Right"},Default="Right",Multi=false,Callback=function(Value)
	Library.NotifySide = Value;
end});
_G.ChooseNotify = "LinoriaLib";
MenuGroup:AddDropdown("NotifyChoose", {Text="Notification Choose",Values={"LinoriaLib","Roblox"},Default="",Multi=false,Callback=function(Value)
	_G.ChooseNotify = Value;
end});
_G.BackpackV2 = true;
MenuGroup:AddToggle("Backpack v2", {Text="Backpack v2",Default=true,Callback=function(Value)
	_G.BackpackV2 = Value;
end});
_G.NotificationSound = true;
MenuGroup:AddToggle("NotifySound", {Text="Notification Sound",Default=true,Callback=function(Value)
	_G.NotificationSound = Value;
end});
MenuGroup:AddSlider("Volume Notification", {Text="Volume Notification",Default=2,Min=2,Max=10,Rounding=1,Compact=true,Callback=function(Value)
	_G.VolumeTime = Value;
end});
MenuGroup:AddSlider("Time Notification", {Text="Time Notification",Default=5,Min=1,Max=25,Rounding=0,Compact=false,Callback=function(Value)
	_G.TimeNotify = Value;
end});
MenuGroup:AddToggle("KeybindMenuOpen", {Default=false,Text="Open Keybind Menu",Callback=function(Value)
	Library.KeybindFrame.Visible = Value;
end});
MenuGroup:AddToggle("ShowCustomCursor", {Text="Custom Cursor",Default=true,Callback=function(Value)
...
Info:AddInput("Join Job", {Default="Nah",Numeric=false,Text="Join Job",Placeholder="UserJobId",Callback=function(Value)
	_G.JobIdJoin = Value;
end});
...
if (_G.Backpack == nil) then
	_G.Backpack = {Old={Hotbar=game:GetService("CoreGui").RobloxGui.Backpack.Hotbar.Position,Inventory=game:GetService("CoreGui").RobloxGui.Backpack.Inventory.Position,["Backpack Number"]={}},New={Hotbar=(game:GetService("CoreGui").RobloxGui.Backpack.Hotbar.Position + UDim2.new(0, 0, 0, -10)),Inventory=UDim2.new(0.5, -100, 1, -260),["Backpack Number"]={}}};
	wait();
